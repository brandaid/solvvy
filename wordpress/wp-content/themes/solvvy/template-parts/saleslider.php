						...
						<article class="slider-info">
							<div class="col-left">
								<div class="slider-info--box">
									...
									<?php if($single_salesman['slider_sales_related_link_title']){ ?>
									<a href="<?php echo $single_salesman['slider_sales_related_link_destination'] ?>" target="<?php echo $single_salesman['open_link'] ?>" class="big-link"><?php echo $single_salesman['slider_sales_related_link_title'] ?></a><br>
									<?php } ?>
									<?php if($single_salesman['slider_sales_call_to_action_text']){ ?>
									<a href="<?php echo $single_salesman['slider_sales_call_to_action_destination'] ?>" target="<?php echo $single_salesman['openlink'] ?>" class="button"><?php echo $single_salesman['slider_sales_call_to_action_text'] ?></a>
									<?php } ?>
								</div>
							</div>
							<div class="col-right">
