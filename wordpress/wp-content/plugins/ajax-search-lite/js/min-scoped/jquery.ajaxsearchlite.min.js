/*! jQuery v1.11.1 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ ! function(n, t) {
    ...
    i.extend({
        expando: "jQuery" + (gi + Math.random()).replace(/\D/g, ""),
        isReady: !0,
        error: function(n) {
            throw new Error(n);
        },
        ...
        isPlainObject: function(n) {
            ...
            try {
                if (n.constructor && !nt.call(n, "constructor") && !nt.call(n.constructor.prototype, "isPrototypeOf")) return !1
            } catch (u) {
                return !1
            }
            if (r.ownLast)
                for (t in n) return nt.call(n, t);
            for (t in n);
            return void 0 === t || nt.call(n, t)
        },
        type: function(n) {
            return null == n ? n + "" : "object" == typeof n || "function" == typeof n ? ct[hf.call(n)] || "object" : typeof n
        },
        ...
        camelCase: function(n) {
            return n.replace(lf, "ms-").replace(af, vf)
        },
        ...
        trim: function(n) {
            return null == n ? "" : (n + "").replace(cf, "")
        },
        makeArray: function(n, t) {
            var r = t || [];
            return null != n && (ti(Object(n)) ? i.merge(r, "string" == typeof n ? [n] : n) : ni.call(r, n)), r
        },
        inArray: function(n, t, i) {
            var r;
            if (t) {
                if (di) return di.call(t, n, i);
    ...
    var tt = function(n) {
        ...
        return wt = r.compile = function(n, t) {
            var r, u = [],
                e = [],
                i = li[n + " "];
            if (!i) {
    ...
    i.unique = tt.uniqueSort;
    i.text = tt.getText;
    i.isXMLDoc = tt.isXML;
    i.contains = tt.contains;
    var nr = i.expr.match.needsContext,
        tr = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        yf = /^.[^:#\[\.,]*$/;
    ...
    function ii(n, t, r) {
        ...
        if ("string" == typeof t) {
            if (yf.test(t)) return i.filter(t, n, r);
            t = i.filter(t, n)
        }
    ...
    i.fn.extend({
        ...
        is: function(n) {
            return !!ii(this, "string" == typeof n && nr.test(n) ? i(n) : n || [], !1).length
        }
    });
    var ft, u = n.document,
        pf = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        wf = i.fn.init = function(n, t) {
            var r, f;
            if (!n) return this;
            if ("string" == typeof n) {
                if (r = "<" === n.charAt(0) && ">" === n.charAt(n.length - 1) && n.length >= 3 ? [null, n, null] : pf.exec(n), !r || !r[1] && t) return !t || t.jquery ? (t || ft).find(n) : this.constructor(t).find(n);
                if (r[1]) {
                    if (t = t instanceof i ? t[0] : t, i.merge(this, i.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : u, !0)), tr.test(r[1]) && i.isPlainObject(t))
    ...
    i.fn.extend({
        ...
        closest: function(n, t) {
            for (var r, f = 0, o = this.length, u = [], e = nr.test(n) || "string" != typeof n ? i(n, t || this.context) : 0; o > f; f++)
    ...
    i.each({
        ...
        i.fn[n] = function(r, u) {
            ...
            return "Until" !== n.slice(-5) && (u = r), u && "string" == typeof u && (f = i.filter(u, f)), this.length > 1 && (kf[n] || (f = i.unique(f)), bf.test(n) && (f = f.reverse())), this.pushStack(f)
        }
    });
    var h = /\S+/g,
        rr = {};
    ...
    i.Callbacks = function(n) {
        n = "string" == typeof n ? rr[n] || df(n) : i.extend({}, n);
        var o, u, h, f, e, c, t = [],
            r = !n.once && [],
            l = function(i) {
    ...
    function a() {
        (u.addEventListener || "load" === event.type || "complete" === u.readyState) && (ur(), i.ready())
    }
    ...
    function fr(n, t, r) {
        if (void 0 === r && 1 === n.nodeType) {
            var u = "data-" + t.replace(te, "-$1").toLowerCase();
            if (r = n.getAttribute(u), "string" == typeof r) {
                try {
                    r = "true" === r ? !0 : "false" === r ? !1 : "null" === r ? null : +r + "" === r ? +r : ne.test(r) ? i.parseJSON(r) : r
                } catch (f) {}
                i.data(n, t, r)
            } else r = void 0
        }
        ...
        if (i.acceptData(n)) {
            ...
            if (f[e]) {
                if (t && (o = u ? f[e] : f[e].data)) {
                    ...
                    if (u ? !ri(o) : !i.isEmptyObject(o)) return
                }(u || (delete f[e].data, ri(f[e]))) && (h ? i.cleanData([n], !0) : r.deleteExpando || f != f.window ? delete f[e] : f[e] = null)
            }
        }
    }
    i.extend({
        ...
        data: function(n, t) {
            ...
            if (void 0 === n) {
                if (this.length && (e = i.data(r), 1 === r.nodeType && !i._data(r, "parsedAttrs"))) {
                    for (f = o.length; f--;) o[f] && (u = o[f].name, 0 === u.indexOf("data-") && (u = i.camelCase(u.slice(5)), fr(r, u, e[u])));
    ...
    var at = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        w = i.access = function(n, t, r, u, f, e, o) {
            var s = 0,
                c = n.length,
                h = null == r;
            if ("object" === i.type(r)) {
    ...
    i.event = {
        ...
        add: function(n, t, r, u, f) {
            var w, y, b, p, o, c, l, a, e, k, d, v = i._data(n);
            if (v) {
                for (r.handler && (p = r, r = p.handler, f = p.selector), r.guid || (r.guid = i.guid++), (y = v.events) || (y = v.events = {}), (c = v.handle) || (c = v.handle = function(n) {
                    ...
                    }, c.elem = n), t = (t || "").match(h) || [""], b = t.length; b--;) w = hr.exec(t[b]) || [], e = d = w[1], k = (w[2] || "").split(".").sort(), e && (o = i.event.special[e] || {}, e = (f ? o.delegateType : o.bindType) || e, o = i.event.special[e] || {}, l = i.extend({
                    type: e,
                    origType: d,
                    data: u,
                    handler: r,
                    ...
                    namespace: k.join(".")
                }, p), (a = y[e]) || (a = y[e] = [], a.delegateCount = 0, o.setup && o.setup.call(n, u, k, c) !== !1 || (n.addEventListener ? n.addEventListener(e, c, !1) : n.attachEvent && n.attachEvent("on" + e, c))), o.add && (o.add.call(n, l), l.handler.guid || (l.handler.guid = r.guid)), f ? a.splice(a.delegateCount++, 0, l) : a.push(l), i.event.global[e] = !0);
                n = null
            }
        },
        remove: function(n, t, r, u, f) {
            ...
            if (v && (a = v.events)) {
                for (t = (t || "").match(h) || [""], p = t.length; p--;)
                    if (s = hr.exec(t[p]) || [], e = k = s[1], w = (s[2] || "").split(".").sort(), e) {
        ...
        trigger: function(t, r, f, e) {
            var l, a, o, p, c, h, w, y = [f || u],
                s = nt.call(t, "type") ? t.type : t,
                v = nt.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = h = f = f || u, 3 !== f.nodeType && 8 !== f.nodeType && !sr.test(s + i.event.triggered) && (s.indexOf(".") >= 0 && (v = s.split("."), s = v.shift(), v.sort()), a = s.indexOf(":") < 0 && "on" + s, t = t[i.expando] ? t : new i.Event(s, "object" == typeof t && t), t.isTrigger = e ? 2 : 3, t.namespace = v.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = f), r = null == r ? [t] : i.makeArray(r, [t]), c = i.event.special[s] || {}, e || !c.trigger || c.trigger.apply(f, r) !== !1)) {
                if (!e && !c.noBubble && !i.isWindow(f)) {
                    for (p = c.delegateType || s, sr.test(p + s) || (o = o.parentNode); o; o = o.parentNode) y.push(o), h = o;
        ...
        fix: function(n) {
            ...
            var e, o, s, r = n.type,
                f = n,
                t = this.fixHooks[r];
            for (t || (this.fixHooks[r] = t = re.test(r) ? this.mouseHooks : ie.test(r) ? this.keyHooks : {}), s = t.props ? this.props.concat(t.props) : this.props, n = new i.Event(f), e = s.length; e--;) o = s[e], n[o] = f[o];
    ...
    r.changeBubbles || (i.event.special.change = {
        setup: function() {
            return fi.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (i.event.add(this, "propertychange._change", function(n) {
    ...
    var ar = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ue = / jQuery\d+="(?:null|\d+)"/g,
        vr = new RegExp("<(?:" + ar + ")[\\s/>]", "i"),
        ei = /^\s+/,
        yr = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
        pr = /<([\w:]+)/,
        wr = /<tbody/i,
        fe = /<|&#?\w+;/,
        ee = /<(?:script|style|link)/i,
        oe = /checked\s*(?:[^=]|=\s*.checked.)/i,
        br = /^$|\/(?:java|ecma)script/i,
        se = /^true\/(.*)/,
        he = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        o = {
        ...
        ce = lr(u),
        oi = ce.appendChild(u.createElement("div"));
    o.optgroup = o.option;
    ...
    function ae(n, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === u && t.text !== n.text ? (dr(t).text = n.text, gr(t)) : "object" === u ? (t.parentNode && (t.outerHTML = n.outerHTML), r.html5Clone && n.innerHTML && !i.trim(t.innerHTML) && (t.innerHTML = n.innerHTML)) : "input" === u && ui.test(n.type) ? (t.defaultChecked = t.checked = n.checked, t.value !== n.value && (t.value = n.value)) : "option" === u ? t.defaultSelected = t.selected = n.defaultSelected : ("input" === u || "textarea" === u) && (t.defaultValue = n.defaultValue)
        }
    }
    i.extend({
        clone: function(n, t, u) {
            var e, c, s, o, h, l = i.contains(n.ownerDocument, n);
            if (r.html5Clone || i.isXMLDoc(n) || !vr.test("<" + n.nodeName + ">") ? s = n.cloneNode(!0) : (oi.innerHTML = n.outerHTML, oi.removeChild(s = oi.firstChild)), !(r.noCloneEvent && r.noCloneChecked || 1 !== n.nodeType && 11 !== n.nodeType || i.isXMLDoc(n)))
                for (e = f(s), h = f(n), o = 0; null != (c = h[o]); ++o) e[o] && ae(c, e[o]);
            if (t)
                if (u)
                    for (h = h || f(n), e = e || f(s), o = 0; null != (c = h[o]); o++) nu(c, e[o]);
                else nu(n, s);
            return e = f(s, "script"), e.length > 0 && si(e, !l && f(n, "script")), e = h = c = null, s
        },
        buildFragment: function(n, t, u, e) {
            for (var c, s, b, h, p, w, a, k = n.length, v = lr(t), l = [], y = 0; k > y; y++)
                if (s = n[y], s || 0 === s)
                    if ("object" === i.type(s)) i.merge(l, s.nodeType ? [s] : s);
                    else if (fe.test(s)) {
                for (h = h || v.appendChild(t.createElement("div")), p = (pr.exec(s) || ["", ""])[1].toLowerCase(), a = o[p] || o._default, h.innerHTML = a[1] + s.replace(yr, "<$1><\/$2>") + a[2], c = a[0]; c--;) h = h.lastChild;
                if (!r.leadingWhitespace && ei.test(s) && l.push(t.createTextNode(ei.exec(s)[0])), !r.tbody)
                    for (s = "table" !== p || wr.test(s) ? "<table>" !== a[1] || wr.test(s) ? 0 : h : h.firstChild, c = s && s.childNodes.length; c--;) i.nodeName(w = s.childNodes[c], "tbody") && !w.childNodes.length && s.removeChild(w);
                for (i.merge(l, h.childNodes), h.textContent = ""; h.firstChild;) h.removeChild(h.firstChild);
                h = v.lastChild
            } else l.push(t.createTextNode(s));
            for (h && v.removeChild(h), r.appendChecked || i.grep(f(l, "input"), le), y = 0; s = l[y++];)
                if ((!e || -1 === i.inArray(s, e)) && (b = i.contains(s.ownerDocument, s), h = f(v.appendChild(s), "script"), b && si(h), u))
                    for (c = 0; s = h[c++];) br.test(s.type || "") && u.push(s);
            return h = null, v
        },
        cleanData: function(n, t) {
            for (var u, e, f, o, a = 0, h = i.expando, l = i.cache, v = r.deleteExpando, y = i.event.special; null != (u = n[a]); a++)
                if ((t || i.acceptData(u)) && (f = u[h], o = f && l[f])) {
                    if (o.events)
                        for (e in o.events) y[e] ? i.event.remove(u, e) : i.removeEvent(u, e, o.handle);
                    l[f] && (delete l[f], v ? delete u[h] : typeof u.removeAttribute !== s ? u.removeAttribute(h) : u[h] = null, c.push(f))
                }
        }
    });
    i.fn.extend({
        ...
        remove: function(n, t) {
            for (var r, e = n ? i.filter(n, this) : this, u = 0; null != (r = e[u]); u++) t || 1 !== r.nodeType || i.cleanData(f(r)), r.parentNode && (t && i.contains(r.ownerDocument, r) && si(f(r, "script")), r.parentNode.removeChild(r));
            return this
        },
        empty: function() {
        ...
        html: function(n) {
            return w(this, function(n) {
                var t = this[0] || {},
                    u = 0,
                    e = this.length;
                if (void 0 === n) return 1 === t.nodeType ? t.innerHTML.replace(ue, "") : void 0;
                if (!("string" != typeof n || ee.test(n) || !r.htmlSerialize && vr.test(n) || !r.leadingWhitespace && ei.test(n) || o[(pr.exec(n) || ["", ""])[1].toLowerCase()])) {
                    n = n.replace(yr, "<$1><\/$2>");
                    try {
        ...
        domManip: function(n, t) {
            ...
            var h, u, c, o, v, s, e = 0,
                ...
                a = n[0],
                y = i.isFunction(a);
            if (y || l > 1 && "string" == typeof a && !r.checkClone && oe.test(a)) return this.each(function(i) {
                var r = p.eq(i);
            ...
            if (l && (s = i.buildFragment(n, this[0].ownerDocument, !1, this), h = s.firstChild, 1 === s.childNodes.length && (s = h), h)) {
                for (o = i.map(f(s, "script"), dr), c = o.length; l > e; e++) u = s, e !== w && (u = i.clone(u, !0, !0), c && i.merge(o, f(u, "script"))), t.call(this[e], u, e);
                if (c)
                    for (v = o[o.length - 1].ownerDocument, i.map(o, gr), e = 0; c > e; e++) u = o[e], br.test(u.type || "") && !i._data(u, "globalEval") && i.contains(v, u) && (u.src ? i._evalUrl && i._evalUrl(u.src) : i.globalEval((u.text || u.textContent || u.innerHTML || "").replace(he, "")));
                s = h = null
            }
            return this
        }
    ...
    i.each({
        ...
        i.fn[n] = function(n) {
            for (var u, r = 0, f = [], e = i(n), o = e.length - 1; o >= r; r++) u = r === o ? this : this.clone(!0), i(e[r])[t](u), ni.apply(f, u.get());
    ...
    function yt(n) {
        var r = u,
            t = tu[n];
        return t || (t = iu(n, r), "none" !== t && t || (ot = (ot || i("<iframe frameborder='0' width='0' height='0'/>")).appendTo(r.documentElement), r = (ot[0].contentWindow || ot[0].contentDocument).document, r.write(), r.close(), t = iu(n, r), ot.detach()), tu[n] = t), t
    }! function() {
        var n;
    ...
    var ru = /^margin/,
        ...
        b, k, ve = /^(top|right|bottom|left)$/;
    n.getComputedStyle ? (b = function(n) {
        return n.ownerDocument.defaultView.getComputedStyle(n, null)
    }, k = function(n, t, r) {
        var e, o, s, u, f = n.style;
        return r = r || b(n), u = r ? r.getPropertyValue(t) || r[t] : void 0, r && ("" !== u || i.contains(n.ownerDocument, n) || (u = i.style(n, t)), pt.test(u) && ru.test(t) && (e = f.width, o = f.minWidth, s = f.maxWidth, f.minWidth = f.maxWidth = f.width = u, u = r.width, f.width = e, f.minWidth = o, f.maxWidth = s)), void 0 === u ? u : u + ""
    }) : u.documentElement.currentStyle && (b = function(n) {
        return n.currentStyle
    }, k = function(n, t, i) {
        var o, f, e, r, u = n.style;
        return i = i || b(n), r = i ? i[t] : void 0, null == r && u && u[t] && (r = u[t]), pt.test(r) && !ve.test(t) && (o = u.left, f = n.runtimeStyle, e = f && f.left, e && (f.left = n.currentStyle.left), u.left = "fontSize" === t ? "1em" : r, r = u.pixelLeft + "px", u.left = o, e && (f.left = e)), void 0 === r ? r : r + "" || "auto"
    });
    ...
    function lu(n, t, u) {
        ...
        if (0 >= f || null == f) {
            if (f = k(n, t, e), (0 > f || null == f) && (f = n.style[t]), pt.test(f)) return f;
            o = s && (r.boxSizingReliable() || f === n.style[t]);
            f = parseFloat(f) || 0
        }
        return f + cu(n, t, u || (s ? "border" : "content"), o, e) + "px"
    }
    i.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(n, t, u, f) {
            if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
                var o, h, e, s = i.camelCase(t),
                    c = n.style;
                if (t = i.cssProps[s] || (i.cssProps[s] = ou(c, s)), e = i.cssHooks[t] || i.cssHooks[s], void 0 === u) return e && "get" in e && void 0 !== (o = e.get(n, !1, f)) ? o : c[t];
                if (h = typeof u, "string" === h && (o = be.exec(u)) && (u = (o[1] + 1) * o[2] + parseFloat(i.css(n, t)), h = "number"), null != u && u === u && ("number" !== h || i.cssNumber[s] || (u += "px"), r.clearCloneStyle || "" !== u || 0 !== t.indexOf("background") || (c[t] = "inherit"), !(e && "set" in e && void 0 === (u = e.set(n, u, f))))) try {
                    c[t] = u
                } catch (l) {}
            }
        },
        css: function(n, t, r, u) {
            ...
            return t = i.cssProps[o] || (i.cssProps[o] = ou(n.style, o)), e = i.cssHooks[t] || i.cssHooks[o], e && "get" in e && (f = e.get(n, !0, r)), void 0 === f && (f = k(n, t, u)), "normal" === f && t in fu && (f = fu[t]), "" === r || r ? (s = parseFloat(f), r === !0 || i.isNumeric(s) ? s || 0 : f) : f
        }
    });
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) {
                if (r) return pe.test(i.css(n, "display")) && 0 === n.offsetWidth ? i.swap(n, ke, function() {
                    return lu(n, t, u)
                }) : lu(n, t, u)
            },
            set: function(n, u, f) {
                var e = f && b(n);
                return hu(n, u, f ? cu(n, t, f, r.boxSizing && "border-box" === i.css(n, "boxSizing", !1, e), e) : 0)
            }
        }
    });
    ...
    i.cssHooks.marginRight = uu(r.reliableMarginRight, function(n, t) {
        ...
        css: function(n, t) {
            return w(this, function(n, t, r) {
                var f, e, o = {},
                    u = 0;
                if (i.isArray(t)) {
                    for (f = b(n), e = t.length; e > u; u++) o[t[u]] = i.css(n, t[u], !1, f);
                    return o
                }
    ...
    i.fx.step = {};
    var rt, wt, de = /^(?:toggle|show|hide)$/,
        au = new RegExp("^(?:([+-])=|)(" + at + ")([a-z%]*)$", "i"),
        ge = /queueHooks$/,
        bt = [no],
        st = {
            "*": [function(n, t) {
                var f = this.createTween(n, t),
                    ...
                    u = (i.cssNumber[n] || "px" !== e && +s) && au.exec(i.css(f.elem, n)),
                    o = 1,
                    h = 20;
                if (u && u[3] !== e) {
                    e = e || u[3];
    ...
    function no(n, t, u) {
        ...
        if (i.isEmptyObject(y)) "inline" === ("none" === h ? yt(n.nodeName) : h) && (o.display = h);
            ...
            for (f in y) v = yu(c ? e[f] : 0, f, l), f in e || (e[f] = v.start, c && (v.end = v.start, v.start = "width" === f || "height" === f ? 1 : 0))
        }
    }
    ...
    function pu(n, t, r) {
        var h, e, o = 0,
            ...
            c = function() {
                if (e) return !1;
                for (var s = rt || vu(), t = Math.max(0, u.startTime + u.duration - s), h = t / u.duration || 0, i = 1 - h, r = 0, o = u.tweens.length; o > r; r++) u.tweens[r].run(i);
            ...
            s = u.props;
        for (to(s, u.opts.specialEasing); l > o; o++)
            if (h = bt[o].call(u, n, s, u.opts)) return h;
        return i.map(s, yu, u), i.isFunction(u.opts.start) && u.opts.start.call(n, u), i.fx.timer(i.extend(c, {
            elem: n,
            anim: u,
            queue: u.opts.queue
        })), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always)
    }
    i.Animation = i.extend(pu, {
        ...
        stop: function(n, t, r) {
            ...
            return "string" != typeof n && (r = t, t = n, n = void 0), t && n !== !1 && this.queue(n || "fx", []), this.each(function() {
                ...
                if (t) f[t] && f[t].stop && u(f[t]);
                    ...
                    for (t in f) f[t] && f[t].stop && ge.test(t) && u(f[t]);
    ...
    i.fn.extend({
        val: function(n) {
            ...
            })) : u ? (t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()], t && "get" in t && void 0 !== (r = t.get(u, "value")) ? r : (r = u.value, "string" == typeof r ? r.replace(io, "") : null == r ? "" : r)) : void 0
        }
    });
    i.extend({
        valHooks: {
    ...
    i.extend({
        attr: function(n, t, r) {
            ...
            if (n && 3 !== e && 8 !== e && 2 !== e) return typeof n.getAttribute === s ? i.prop(n, t, r) : (1 === e && i.isXMLDoc(n) || (t = t.toLowerCase(), u = i.attrHooks[t] || (i.expr.match.bool.test(t) ? wu : ut)), void 0 === r ? u && "get" in u && null !== (f = u.get(n, t)) ? f : (f = i.find.attr(n, t), null == f ? void 0 : f) : null !== r ? u && "set" in u && void 0 !== (f = u.set(n, r, t)) ? f : (n.setAttribute(t, r + ""), r) : void i.removeAttr(n, t))
        },
        removeAttr: function(n, t) {
            var r, u, e = 0,
                f = t && t.match(h);
            if (f && 1 === n.nodeType)
                while (r = f[e++]) u = i.propFix[r] || r, i.expr.match.bool.test(r) ? dt && d || !ci.test(r) ? n[u] = !1 : n[i.camelCase("default-" + r)] = n[u] = !1 : i.attr(n, r, ""), n.removeAttribute(d ? r : u)
        },
        attrHooks: {
            type: {
                set: function(n, t) {
    ...
    wu = {
        set: function(n, t, r) {
            return t === !1 ? i.removeAttr(n, r) : dt && d || !ci.test(r) ? n.setAttribute(!d && i.propFix[r] || r, r) : n[i.camelCase("default-" + r)] = n[r] = !0, r
        }
    };
    i.each(i.expr.match.bool.source.match(/\w+/g), function(n, t) {
        var r = v[t] || i.find.attr;
        v[t] = dt && d || !ci.test(t) ? function(n, t, i) {
            var u, f;
    ...
    var ro = /^(?:input|select|textarea|button|object)$/i,
        uo = /^(?:a|area)$/i;
    i.fn.extend({
        prop: function(n, t) {
        ...
        propHooks: {
            tabIndex: {
                get: function(n) {
                    ...
                    return t ? parseInt(t, 10) : ro.test(n.nodeName) || uo.test(n.nodeName) && n.href ? 0 : -1
                }
            }
        }
    });
    ...
    i.fn.extend({
        addClass: function(n) {
            ...
            if (l)
                for (o = (n || "").match(h) || []; c > e; e++)
                    if (t = this[e], r = 1 === t.nodeType && (t.className ? (" " + t.className + " ").replace(li, " ") : " ")) {
        ...
        hasClass: function(n) {
            for (var i = " " + n + " ", t = 0, r = this.length; r > t; t++)
                if (1 === this[t].nodeType && (" " + this[t].className + " ").replace(li, " ").indexOf(i) >= 0) return !0;
            return !1
        }
    });
    ...
    i.parseJSON = function(t) {
        ...
        var f, r = null,
            u = i.trim(t + "");
        return u && !i.trim(u.replace(fo, function(n, t, i, u) {
    ...
    i.extend({
        ...
        ajax: function(n, t) {
            ...
            var s, c, f, b, k, l, a, v, r = i.ajaxSetup({}, t),
                ...
                u = {
                    ...
                    getResponseHeader: function(n) {
                        ...
                        if (2 === e) {
                            if (!v)
                                for (v = {}; t = oo.exec(b);) v[t[1].toLowerCase()] = t[2];
                            t = v[n.toLowerCase()]
                        }
            ...
            if (nt.promise(u).complete = tt.add, u.success = u.done, u.error = u.fail, r.url = ((n || r.url || y) + "").replace(eo, "").replace(ho, g[1] + "//"), r.type = t.method || t.type || r.method || r.type, r.dataTypes = i.trim(r.dataType || "*").toLowerCase().match(h) || [""], null == r.crossDomain && (s = ku.exec(r.url.toLowerCase()), r.crossDomain = !(!s || s[1] === g[1] && s[2] === g[2] && (s[3] || ("http:" === s[1] ? "80" : "443")) === (g[3] || ("http:" === g[1] ? "80" : "443")))), r.data && r.processData && "string" != typeof r.data && (r.data = i.param(r.data, r.traditional)), tf(du, r, t, u), 2 === e) return u;
            l = r.global;
            l && 0 == i.active++ && i.event.trigger("ajaxStart");
            r.type = r.type.toUpperCase();
            r.hasContent = !so.test(r.type);
            f = r.url;
            r.hasContent || (r.data && (f = r.url += (vi.test(f) ? "&" : "?") + r.data, delete r.data), r.cache === !1 && (r.url = bu.test(f) ? f.replace(bu, "$1_=" + ai++) : f + (vi.test(f) ? "&" : "?") + "_=" + ai++));
            ...
            u.setRequestHeader("Accept", r.dataTypes[0] && r.accepts[r.dataTypes[0]] ? r.accepts[r.dataTypes[0]] + ("*" !== r.dataTypes[0] ? ", " + gu + "; q=0.01" : "") : r.accepts["*"]);
            ...
            function w(n, t, s, h) {
                var v, it, g, y, w, c = t;
                2 !== e && (e = 2, k && clearTimeout(k), a = void 0, b = h || "", u.readyState = n > 0 ? 4 : 0, v = n >= 200 && 300 > n || 304 === n, s && (y = co(r, u, s)), y = lo(r, y, u, v), v ? (r.ifModified && (w = u.getResponseHeader("Last-Modified"), w && (i.lastModified[f] = w), w = u.getResponseHeader("etag"), w && (i.etag[f] = w)), 204 === n || "HEAD" === r.type ? c = "nocontent" : 304 === n ? c = "notmodified" : (c = y.state, it = y.data, g = y.error, v = !g)) : (g = c, (n || !c) && (c = "error", 0 > n && (n = 0))), u.status = n, u.statusText = (t || c) + "", v ? nt.resolveWith(o, [it, c, u]) : nt.rejectWith(o, [u, c, g]), u.statusCode(p), p = void 0, l && d.trigger(v ? "ajaxSuccess" : "ajaxError", [u, r, v ? it : g]), tt.fireWith(o, [u, c]), l && (d.trigger("ajaxComplete", [u, r]), --i.active || i.event.trigger("ajaxStop")))
            }
            return u
        },
    ...
    var ao = /%20/g,
        vo = /\[\]$/,
        rf = /\r?\n/g,
        yo = /^(?:submit|button|image|reset|file)$/i,
        po = /^(?:input|select|textarea|keygen)/i;

    function wi(n, t, r, u) {
        var f;
        if (i.isArray(t)) i.each(t, function(t, i) {
            r || vo.test(n) ? u(n, i) : wi(n + "[" + ("object" == typeof i ? t : "") + "]", i, r, u)
        });
        else if (r || "object" !== i.type(t)) u(n, t);
        else
            for (f in t) wi(n + "[" + f + "]", t[f], r, u)
    }
    i.param = function(n, t) {
        ...
        if (void 0 === t && (t = i.ajaxSettings && i.ajaxSettings.traditional), i.isArray(n) || n.jquery && !i.isPlainObject(n)) i.each(n, function() {
            ...
            for (r in n) wi(r, n[r], t, f);
        return u.join("&").replace(ao, "+")
    };
    i.fn.extend({
        serialize: function() {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var n = this.type;
                return this.name && !i(this).is(":disabled") && po.test(this.nodeName) && !yo.test(n) && (this.checked || !ui.test(n))
            }).map(function(n, t) {
                var r = i(this).val();
    ...
    i.ajaxSettings.xhr = void 0 !== n.ActiveXObject ? function() {
        return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && uf() || bo()
    } : uf;
    var wo = 0,
        gt = {},
    ...
    i.ajaxSetup({
        ...
        jsonpCallback: function() {
            var n = ff.pop() || i.expando + "_" + ai++;
            return this[n] = !0, n
        }
    });
    i.ajaxPrefilter("json jsonp", function(t, r, u) {
        var f, o, e, s = t.jsonp !== !1 && (bi.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && bi.test(t.data) && "data");
        if (s || "jsonp" === t.dataTypes[0]) return (f = t.jsonpCallback = i.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(bi, "$1" + f) : t.jsonp !== !1 && (t.url += (vi.test(t.url) ? "&" : "?") + t.jsonp + "=" + f), t.converters["script json"] = function() {
            return e || i.error(f + " was not called"), e[0]
        }, t.dataTypes[0] = "json", o = n[f], n[f] = function() {
            e = arguments
        }, u.always(function() {
            n[f] = o;
            t[f] && (t.jsonpCallback = r.jsonpCallback, ff.push(f));
    ...
    i.fn.load = function(n, t, r) {
        if ("string" != typeof n && ef) return ef.apply(this, arguments);
        var u, o, s, f = this,
            e = n.indexOf(" ");
    ...
    var of = n.document.documentElement;
    ...
    i.fn.extend({
        offset: function(n) {
            ...
            var t, f, u = {
                ...
                r = this[0],
                e = r && r.ownerDocument;
            if (e) return t = e.documentElement, i.contains(t, r) ? (typeof r.getBoundingClientRect !== s && (u = r.getBoundingClientRect()), f = sf(e), {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var n = this.offsetParent || of; n && !i.nodeName(n, "html") && "static" === i.css(n, "position");) n = n.offsetParent;
                return n || of
            })
        }
    });
    ...
    i.each(["top", "left"], function(n, t) {
        i.cssHooks[t] = uu(r.pixelPosition, function(n, r) {
            if (r) return (r = k(n, t), pt.test(r) ? i(n).position()[t] + "px" : r)
        })
    });
    i.each({
        Height: "height",
    ...
    "function" == typeof define && define.amd && define("asljQuery", [], function() {
        return i
    });
    var ko = n.jQuery,
        go = n.$;
    return i.noConflict = function(t) {
        return n.$ === i && (n.$ = go), t && n.jQuery === i && (n.asljQuery = ko), i
    }, typeof t === s && (n.asljQuery = n.$ = i), i
}),
function(n, t, i) {
    (function(t) {
        typeof define == "function" && !1 && define.amd && define.amd.jQuery ? define(["jquery"], t) : typeof module != "undefined" && !1 && module.exports ? t(require("jquery")) : t(n)
    })(function(n) {
        var u = "left",
            f = "right",
            e = "up",
            ...
            r = "cancel",
            l = "ontouchstart" in i,
            v = i.navigator.msPointerEnabled && !i.navigator.pointerEnabled && !l,
            h = (i.navigator.pointerEnabled || i.navigator.msPointerEnabled) && !l,
            c = "TouchSwipe";
        n.fn.swipe = function(t) {
            ...
            else if (!i && (typeof t == "object" || !t)) return et.apply(this, arguments);
            return r
        };
        ...
        function et(t) {
            return t && t.allowPageScroll === undefined && (t.swipe !== undefined || t.swipeStatus !== undefined) && (t.allowPageScroll = w), t.click !== undefined && t.tap === undefined && (t.tap = t.click), t || (t = {}), t = n.extend({}, n.fn.swipe.defaults, t), this.each(function() {
                var r = n(this),
                    i = r.data(c);
                i || (i = new ot(this, t), r.data(c, i))
            })
        }

        function ot(i, et) {
            var et = n.extend({}, et),
                si = l || h || !et.fallbackToMouseEvents,
                hi = si ? h ? v ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown",
                ki = si ? h ? v ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove",
                di = si ? h ? v ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup",
                ri = si ? h ? "mouseleave" : null : "mouseleave",
                ci = h ? v ? "MSPointerCancel" : "pointercancel" : "touchcancel",
                at = 0,
                vt = null,
                yt = null,
                lt = 0,
            ...
            function tr(t) {
                if (!pu() && !(n(t.target).closest(et.excludedElements, ot).length > 0)) {
                    var i = t.originalEvent ? t.originalEvent : t,
                        f, u = i.touches,
                        e = u ? u[0] : i;
                    return (st = ut, u ? ct = u.length : et.preventDefaultEvents !== !1 && t.preventDefault(), at = 0, vt = null, yt = null, kt = null, lt = 0, gt = 0, ni = 0, pt = 1, bt = 0, li = ku(), dr(), wi(0, e), !u || ct === et.fingers || et.fingers === a || oi() ? (gi = ii(), ct == 2 && (wi(1, u[1]), gt = ni = cr(ht[0].start, ht[1].start)), (et.swipeStatus || et.pinchStatus) && (f = wt(i, st))) : f = !1, f === !1) ? (st = r, wt(i, st), f) : (et.hold && (ei = setTimeout(n.proxy(function() {
                        ot.trigger("hold", [i.target]);
                        et.hold && (f = et.hold.call(ot, i, i.target))
            ...
            function ir(n) {
                ...
                if (st !== t && st !== r && !yi()) {
                    var o, i = f.touches,
                        h = i ? i[0] : f,
                        u = gr(h);
                    if (ai = ii(), i && (ct = i.length), et.hold && clearTimeout(ei), st = s, ct == 2 && (gt == 0 ? (wi(1, i[1]), gt = ni = cr(ht[0].start, ht[1].start)) : (gr(i[1]), ni = cr(ht[0].end, ht[1].end), kt = gu(ht[0].end, ht[1].end)), pt = du(gt, ni), bt = Math.abs(gt - ni)), ct === et.fingers || et.fingers === a || !i || oi()) {
                        if (vt = iu(u.start, u.end), yt = iu(u.last, u.end), uu(n, yt), at = nf(u.start, u.end), lt = tu(), bu(vt, at), o = wt(f, st), !et.triggerOnTouchEnd || et.triggerOnTouchLeave) {
                            var e = !0;
                            if (et.triggerOnTouchLeave) {
                                var c = rf(this);
                                e = uf(u.end, c)
                            }!et.triggerOnTouchEnd && e ? st = fr(s) : et.triggerOnTouchLeave && !e && (st = fr(t));
                            (st == r || st == t) && wt(f, st)
                        }
                    } else st = r, wt(f, st);
                    o === !1 && (st = r, wt(f, st))
            ...
            function rr(n) {
                var i = n.originalEvent ? n.originalEvent : n,
                    u = i.touches;
                if (u) {
                    if (u.length && !yi()) return yu(i), !0;
                    if (u.length && yi()) return !0
                }
                return yi() && (ct = nr), ai = ii(), lt = tu(), or() || !er() ? (st = r, wt(i, st)) : et.triggerOnTouchEnd || et.triggerOnTouchEnd == !1 && st === s ? (et.preventDefaultEvents !== !1 && n.preventDefault(), st = t, wt(i, st)) : !et.triggerOnTouchEnd && br() ? (st = t, dt(i, st, d)) : st === s && (st = r, wt(i, st)), pi(!1), null
            }
            ...
            function fr(n) {
                var i = n,
                    ...
                    u = er(),
                    e = or();
                return !f || e ? i = r : u && n == s && (!et.triggerOnTouchEnd || et.triggerOnTouchLeave) ? i = t : !u && n == t && et.triggerOnTouchLeave && (i = r), i
            }

            function wt(n, i) {
                var u, f = n.touches;
                return (eu() || sr()) && (u = dt(n, i, b)), (fu() || oi()) && u !== !1 && (u = dt(n, i, k)), au() && u !== !1 ? u = dt(n, i, it) : vu() && u !== !1 ? u = dt(n, i, rt) : lu() && u !== !1 && (u = dt(n, i, d)), i === r && (sr() && (u = dt(n, i, b)), oi() && (u = dt(n, i, k)), ui(n)), i === t && (f ? f.length || ui(n) : ui(n)), u
            }

            function dt(i, s, h) {
                var c;
                if (h == b) {
                    if (ot.trigger("swipeStatus", [s, vt || null, at || 0, lt || 0, ct, ht, yt]), et.swipeStatus && (c = et.swipeStatus.call(ot, i, s, vt || null, at || 0, lt || 0, ct, ht, yt), c === !1)) return !1;
                    if (s == t && yr()) {
                        if (clearTimeout(fi), clearTimeout(ei), ot.trigger("swipe", [vt, at, lt, ct, ht, yt]), et.swipe && (c = et.swipe.call(ot, i, vt, at, lt, ct, ht, yt), c === !1)) return !1;
                        switch (vt) {
                            case u:
                                ot.trigger("swipeLeft", [vt, at, lt, ct, ht, yt]);
                                et.swipeLeft && (c = et.swipeLeft.call(ot, i, vt, at, lt, ct, ht, yt));
                                break;
                            case f:
                                ot.trigger("swipeRight", [vt, at, lt, ct, ht, yt]);
                                et.swipeRight && (c = et.swipeRight.call(ot, i, vt, at, lt, ct, ht, yt));
                                break;
                            case e:
                                ot.trigger("swipeUp", [vt, at, lt, ct, ht, yt]);
                                et.swipeUp && (c = et.swipeUp.call(ot, i, vt, at, lt, ct, ht, yt));
                                break;
                            case o:
                                ot.trigger("swipeDown", [vt, at, lt, ct, ht, yt]);
                                et.swipeDown && (c = et.swipeDown.call(ot, i, vt, at, lt, ct, ht, yt))
                        }
                    }
                }
                if (h == k) {
                    if (ot.trigger("pinchStatus", [s, kt || null, bt || 0, lt || 0, ct, pt, ht]), et.pinchStatus && (c = et.pinchStatus.call(ot, i, s, kt || null, bt || 0, lt || 0, ct, pt, ht), c === !1)) return !1;
                    if (s == t && vr()) switch (kt) {
                        case y:
                            ot.trigger("pinchIn", [kt || null, bt || 0, lt || 0, ct, pt, ht]);
                            et.pinchIn && (c = et.pinchIn.call(ot, i, kt || null, bt || 0, lt || 0, ct, pt, ht));
                            break;
                        case p:
                            ot.trigger("pinchOut", [kt || null, bt || 0, lt || 0, ct, pt, ht]);
                            et.pinchOut && (c = et.pinchOut.call(ot, i, kt || null, bt || 0, lt || 0, ct, pt, ht))
                    }
                }
                return h == d ? (s === r || s === t) && (clearTimeout(fi), clearTimeout(ei), hr() && !su() ? (ti = ii(), fi = setTimeout(n.proxy(function() {
                    ti = null;
                    ot.trigger("tap", [i.target]);
                    et.tap && (c = et.tap.call(ot, i, i.target))
                }, this), et.doubleTapThreshold)) : (ti = null, ot.trigger("tap", [i.target]), et.tap && (c = et.tap.call(ot, i, i.target)))) : h == it ? (s === r || s === t) && (clearTimeout(fi), clearTimeout(ei), ti = null, ot.trigger("doubletap", [i.target]), et.doubleTap && (c = et.doubleTap.call(ot, i, i.target))) : h == rt && (s === r || s === t) && (clearTimeout(fi), ti = null, ot.trigger("longtap", [i.target]), et.longTap && (c = et.longTap.call(ot, i, i.target))), c
            }
            ...
            function uu(n, t) {
                if (et.preventDefaultEvents !== !1)
                    if (et.allowPageScroll === w) n.preventDefault();
                    else {
                        var i = et.allowPageScroll === tt;
                        switch (t) {
                            case u:
                                (et.swipeLeft && i || !i && et.allowPageScroll != g) && n.preventDefault();
                                break;
                            case f:
                                (et.swipeRight && i || !i && et.allowPageScroll != g) && n.preventDefault();
                                break;
                            case e:
                                (et.swipeUp && i || !i && et.allowPageScroll != nt) && n.preventDefault();
                                break;
                            case o:
                                (et.swipeDown && i || !i && et.allowPageScroll != nt) && n.preventDefault()
                        }
                    }
            }
            ...
            function pi(n) {
                ot && (n === !0 ? (ot.bind(ki, ir), ot.bind(di, rr), ri && ot.bind(ri, ur)) : (ot.unbind(ki, ir, !1), ot.unbind(di, rr, !1), ri && ot.unbind(ri, ur, !1)), ot.data(c + "_intouch", n === !0))
            }
            ...
            function ku() {
                var n = {};
                return n[u] = bi(u), n[f] = bi(f), n[e] = bi(e), n[o] = bi(o), n
            }
...
function(n) {
    n.extend({
        highlight: function(t, i, r, u) {
            if (t.nodeType === 3) {
                var o = t.data.match(i);
                if (o) {
                    var s = document.createElement(r || "span");
                    s.className = u || "highlight";
                    var f = t.splitText(o.index);
                    f.splitText(o[0].length);
                    var h = f.cloneNode(!0);
                    return s.appendChild(h), f.parentNode.replaceChild(s, f), 1
                }
            } else if (t.nodeType === 1 && t.childNodes && !/(script|style)/i.test(t.tagName) && !(t.tagName === r.toUpperCase() && t.className === u))
                for (var e = 0; e < t.childNodes.length; e++) e += n.highlight(t.childNodes[e], i, r, u);
            return 0
        }
    });
    n.fn.unhighlight = function(t) {
        var i = {
            className: "highlight",
            element: "span"
        };
        return n.extend(i, t), this.find(i.element + "." + i.className).each(function() {
            var n = this.parentNode;
            n.replaceChild(this.firstChild, this);
            n.normalize()
        }).end()
    };
    n.fn.highlight = function(t, i) {
        var r = {
            className: "highlight",
            element: "span",
            caseSensitive: !1,
        ...
        if (n.extend(r, i), t.constructor === String && (t = [t]), t = n.grep(t, function(n) {
                return n != ""
            }), t = n.map(t, function(n) {
                return n.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&")
            }), t.length == 0) return this;
        var f = r.caseSensitive ? "" : "i",
            u = "(" + t.join("|") + ")";
        r.wordsOnly && (u = "\\b" + u + "\\b");
        var e = new RegExp(u, f);
        return this.each(function() {
            n.highlight(this, e, r.element, r.className)
        })
    }
}(asljQuery, asljQuery, window),
function(n, t, i) {
    ! function(t) {
        "function" == typeof define && !1 && define.amd ? define(["jquery"], t) : "object" == typeof exports && !1 ? module.exports = t : t(n)
    }(function(n) {
        function f(r) {
            var f = r || i.event,
                w = l.call(arguments, 1),
                a = 0,
                h = 0,
                s = 0,
                v = 0,
                b = 0,
                k = 0;
            if (r = n.event.fix(f), r.type = "mousewheel", "detail" in f && (s = -1 * f.detail), "wheelDelta" in f && (s = f.wheelDelta), "wheelDeltaY" in f && (s = f.wheelDeltaY), "wheelDeltaX" in f && (h = -1 * f.wheelDeltaX), "axis" in f && f.axis === f.HORIZONTAL_AXIS && (h = -1 * s, s = 0), a = 0 === s ? h : s, "deltaY" in f && (s = -1 * f.deltaY, a = s), "deltaX" in f && (h = f.deltaX, 0 === s && (a = -1 * h)), 0 !== s || 0 !== h) {
                if (1 === f.deltaMode) {
                    var y = n.data(this, "mousewheel-line-height");
                    a *= y;
                    s *= y;
                    h *= y
                } else if (2 === f.deltaMode) {
                    var p = n.data(this, "mousewheel-page-height");
                    a *= p;
                    s *= p;
                    h *= p
                }
                if (v = Math.max(Math.abs(s), Math.abs(h)), (!t || t > v) && (t = v, o(f, v) && (t /= 40)), o(f, v) && (a /= 40, h /= 40, s /= 40), a = Math[a >= 1 ? "floor" : "ceil"](a / t), h = Math[h >= 1 ? "floor" : "ceil"](h / t), s = Math[s >= 1 ? "floor" : "ceil"](s / t), u.settings.normalizeOffset && this.getBoundingClientRect) {
                    var d = this.getBoundingClientRect();
                    b = r.clientX - d.left;
                    k = r.clientY - d.top
                }
                return r.deltaX = h, r.deltaY = s, r.deltaFactor = t, r.offsetX = b, r.offsetY = k, r.deltaMode = 0, w.unshift(r, a, h, s), e && clearTimeout(e), e = setTimeout(c, 200), (n.event.dispatch || n.event.handle).apply(this, w)
            }
        }
        ...
        function o(n, t) {
            return u.settings.adjustOldDeltas && "mousewheel" === n.type && t % 120 == 0
        }
        var e, t, s = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
            r = "onwheel" in document || document.documentMode >= 9 ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"],
            l = Array.prototype.slice;
        if (n.event.fixHooks)
            for (var h = s.length; h;) n.event.fixHooks[s[--h]] = n.event.mouseHooks;
        var u = n.event.special.mousewheel = {
            version: "3.1.12",
            setup: function() {
                if (this.addEventListener)
                    for (var t = r.length; t;) this.addEventListener(r[--t], f, !1);
                else this.onmousewheel = f;
                n.data(this, "mousewheel-line-height", u.getLineHeight(this));
                n.data(this, "mousewheel-page-height", u.getPageHeight(this))
            },
            teardown: function() {
                if (this.removeEventListener)
                    for (var t = r.length; t;) this.removeEventListener(r[--t], f, !1);
    ...
    typeof n.fn.mCustScr == "undefined" ? ! function(t) {
        "function" == typeof define && !1 && define.amd ? define(["jquery"], t) : "undefined" != typeof module && !1 && module.exports ? module.exports = t : t(n, i, document)
    }(function(n) {
        ! function(t) {
            ...
            var c, l = "mCustScr",
                ...
                wt = 0,
                k = {},
                w = i.attachEvent && !i.addEventListener ? 1 : 0,
                o = !1,
                r = ["mCSBap_dragger_onDrag", "mCSBap_scrollTools_onDrag", "mCS_img_loaded", "mCS_disabled", "mCS_destroyed", "mCS_no_scrollbar", "mCS-autoHide", "mCS-dir-rtl", "mCS_no_scrollbar_y", "mCS_no_scrollbar_x", "mCS_y_hidden", "mCS_x_hidden", "mCSBap_draggerContainer", "mCSBap_buttonUp", "mCSBap_buttonDown", "mCSBap_buttonLeft", "mCSBap_buttonRight"],
                h = {
                    init: function(i) {
                        var i = n.extend(!0, {}, st, i),
                            e = y.call(this);
                        if (i.live) {
                            var u = i.liveSelector || this.selector || rt,
                                f = n(u);
                            if ("off" === i.live) return void d(u);
                            k[u] = setTimeout(function() {
                                f.mCustScr(i);
                                "once" === i.live && f.length && d(u)
                            }, 500)
                        } else d(u);
                        return i.setWidth = i.set_width ? i.set_width : i.setWidth, i.setHeight = i.set_height ? i.set_height : i.setHeight, i.axis = i.horizontalScroll ? "x" : bt(i.axis), i.scrollInertia = i.scrollInertia > 0 && i.scrollInertia < 17 ? 17 : i.scrollInertia, "object" != typeof i.mouseWheel && 1 == i.mouseWheel && (i.mouseWheel = {
                            enable: !0,
                            scrollAmount: "auto",
                            axis: "y",
                            preventDefault: !1,
                            ...
                            normalizeDelta: !1,
                            invert: !1
                        }), i.mouseWheel.scrollAmount = i.mouseWheelPixels ? i.mouseWheelPixels : i.mouseWheel.scrollAmount, i.mouseWheel.normalizeDelta = i.advanced.normalizeMouseWheelDelta ? i.advanced.normalizeMouseWheelDelta : i.mouseWheel.normalizeDelta, i.scrollButtons.scrollType = kt(i.scrollButtons.scrollType), ht(i), n(e).each(function() {
                            var u = n(this);
                            if (!u.data(t)) {
                                u.data(t, {
                                    idx: ++wt,
                                ...
                                var e = u.data(t),
                                    f = e.opt,
                                    o = u.data("mcs-axis"),
                                    s = u.data("mcs-scrollbar-position"),
                                    c = u.data("mcs-theme");
                                o && (f.axis = o);
                                s && (f.scrollbarPosition = s);
                                c && (f.theme = c, ht(f));
                                dt.call(this);
                                e && f.callbacks.onCreate && "function" == typeof f.callbacks.onCreate && f.callbacks.onCreate.call(this);
                                n("#mCSBap_" + e.idx + "_container img:not(." + r[2] + ")").addClass(r[2]);
                                h.update.call(null, u)
                            }
                        })
                    },
                    update: function(i, u) {
                        ...
                        return n(e).each(function() {
                            ...
                            if (o.data(t)) {
                                ...
                                if (!h.length) return;
                                e.tweenRunning && s(o);
                                u && e && i.callbacks.onBeforeUpdate && "function" == typeof i.callbacks.onBeforeUpdate && i.callbacks.onBeforeUpdate.call(this);
                                o.hasClass(r[3]) && o.removeClass(r[3]);
                                o.hasClass(r[4]) && o.removeClass(r[4]);
                                a.css("max-height", "none");
                                a.height() !== o.height() && a.css("max-height", o.height());
                                gt.call(this);
                                "y" === i.axis || i.advanced.autoExpandHorizontalScroll || h.css("width", ct(h));
                                e.overflowed = ri.call(this);
                                lt.call(this);
                                i.autoDraggerLength && ti.call(this);
                                ii.call(this);
                                ui.call(this);
                                var l = [Math.abs(h[0].offsetTop), Math.abs(h[0].offsetLeft)];
                                "x" !== i.axis && (e.overflowed[0] ? c[0].height() > c[0].parent().height() ? p.call(this) : (f(o, l[0].toString(), {
                                    dir: "y",
                                    dur: 0,
                                    overwrite: "none"
                                }), e.contentReset.y = null) : (p.call(this), "y" === i.axis ? nt.call(this) : "yx" === i.axis && e.overflowed[1] && f(o, l[1].toString(), {
                                    dir: "x",
                                    dur: 0,
                                    overwrite: "none"
                                })));
                                "y" !== i.axis && (e.overflowed[1] ? c[1].width() > c[1].parent().width() ? p.call(this) : (f(o, l[1].toString(), {
                                    dir: "x",
                                    dur: 0,
                                    overwrite: "none"
                                }), e.contentReset.x = null) : (p.call(this), "x" === i.axis ? nt.call(this) : "yx" === i.axis && e.overflowed[0] && f(o, l[0].toString(), {
                                    dir: "y",
                                    dur: 0,
                                    overwrite: "none"
                                })));
                                u && e && (2 === u && i.callbacks.onImageLoad && "function" == typeof i.callbacks.onImageLoad ? i.callbacks.onImageLoad.call(this) : 3 === u && i.callbacks.onSelectorChange && "function" == typeof i.callbacks.onSelectorChange ? i.callbacks.onSelectorChange.call(this) : i.callbacks.onUpdate && "function" == typeof i.callbacks.onUpdate && i.callbacks.onUpdate.call(this));
                                ot.call(this)
                            }
                        })
                    },
                        ...
                        if ("undefined" != typeof i && null != i) {
                            ...
                            return n(u).each(function() {
                                ...
                                if (s.data(t)) {
                                    ...
                                    e[0] = vt.call(this, e[0], "y");
                                    e[1] = vt.call(this, e[1], "x");
                                    u.moveDragger && (e[0] *= o.scrollRatio.y, e[1] *= o.scrollRatio.x);
                                    u.dur = bi() ? 0 : l;
                                    setTimeout(function() {
                                        null !== e[0] && "undefined" != typeof e[0] && "x" !== h.axis && o.overflowed[0] && (u.dir = "y", u.overwrite = "all", f(s, e[0].toString(), u));
                                        null !== e[1] && "undefined" != typeof e[1] && "y" !== h.axis && o.overflowed[1] && (u.dir = "x", u.overwrite = "none", f(s, e[1].toString(), u))
                                    }, u.timeout)
                                }
                            })
                        }
                    ...
                    disable: function(i) {
                        ...
                        return n(u).each(function() {
                            var u = n(this);
                            u.data(t) && (u.data(t), ot.call(this, "remove"), nt.call(this), i && p.call(this), lt.call(this, !0), u.addClass(r[3]))
                        })
                    },
                    destroy: function() {
                        var i = y.call(this);
                        return n(i).each(function() {
                            ...
                            if (f.data(t)) {
                                ...
                                e.live && d(e.liveSelector || n(i).selector);
                                ot.call(this, "remove");
                                nt.call(this);
                                p.call(this);
                                f.removeData(t);
                                v(this, "mcs");
                                h.remove();
                                o.find("img." + r[2]).removeClass(r[2]);
                                s.replaceWith(o.contents());
                                f.removeClass(l + " _" + t + "_" + u.idx + " " + r[6] + " " + r[7] + " " + r[5] + " " + r[3]).addClass(r[4])
                            }
                        })
                    }
                },
                y = function() {
                    return "object" != typeof n(this) || n(this).length < 1 ? rt : this
                },
                ht = function(t) {
                ...
                dt = function() {
                    var f = n(this),
                        u = f.data(t),
                        i = u.opt,
                        h = i.autoExpandScrollbar ? " " + r[1] + "_expand" : "",
                        e = ["<div id='mCSBap_" + u.idx + "_scrollbar_vertical' class='mCSBap_scrollTools mCSBap_" + u.idx + "_scrollbar mCS-" + i.theme + " mCSBap_scrollTools_vertical" + h + "'><div class='" + r[12] + "'><div id='mCSBap_" + u.idx + "_dragger_vertical' class='mCSBap_dragger' style='position:absolute;'><div class='mCSBap_dragger_bar' /><\/div><div class='mCSBap_draggerRail' /><\/div><\/div>", "<div id='mCSBap_" + u.idx + "_scrollbar_horizontal' class='mCSBap_scrollTools mCSBap_" + u.idx + "_scrollbar mCS-" + i.theme + " mCSBap_scrollTools_horizontal" + h + "'><div class='" + r[12] + "'><div id='mCSBap_" + u.idx + "_dragger_horizontal' class='mCSBap_dragger' style='position:absolute;'><div class='mCSBap_dragger_bar' /><\/div><div class='mCSBap_draggerRail' /><\/div><\/div>"],
                        v = "yx" === i.axis ? "mCSBap_vertical_horizontal" : "x" === i.axis ? "mCSBap_horizontal" : "mCSBap_vertical",
                        c = "yx" === i.axis ? e[0] + e[1] : "x" === i.axis ? e[1] : e[0],
                        y = "yx" === i.axis ? "<div id='mCSBap_" + u.idx + "_container_wrapper' class='mCSBap_container_wrapper' />" : "",
                        p = i.autoHideScrollbar ? " " + r[6] : "",
                        w = "x" !== i.axis && "rtl" === u.langDir ? " " + r[7] : "";
                    i.setWidth && f.css("width", i.setWidth);
                    i.setHeight && f.css("height", i.setHeight);
                    i.setLeft = "y" !== i.axis && "rtl" === u.langDir ? "989999px" : i.setLeft;
                    f.addClass(l + " _" + t + "_" + u.idx + p + w).wrapInner("<div id='mCSBap_" + u.idx + "' class='mCustomScrollBox mCS-" + i.theme + " " + v + "'><div id='mCSBap_" + u.idx + "_container' class='mCSBap_container' style='position:relative; top:" + i.setTop + "; left:" + i.setLeft + ";' dir='" + u.langDir + "' /><\/div>");
                    var a = n("#mCSBap_" + u.idx),
                        s = n("#mCSBap_" + u.idx + "_container");
                    "y" === i.axis || i.advanced.autoExpandHorizontalScroll || s.css("width", ct(s));
                    "outside" === i.scrollbarPosition ? ("static" === f.css("position") && f.css("position", "relative"), f.css("overflow", "visible"), a.addClass("mCSBap_outside").after(c)) : (a.addClass("mCSBap_inside").append(c), s.wrap(y));
                    ni.call(this);
                ...
                ni = function() {
                    var s = n(this),
                        ...
                        f = it(u.scrollButtons.tabindex) ? "tabindex='" + u.scrollButtons.tabindex + "'" : "",
                        i = ["<a href='#' class='" + r[13] + "' " + f + " />", "<a href='#' class='" + r[14] + "' " + f + " />", "<a href='#' class='" + r[15] + "' " + f + " />", "<a href='#' class='" + r[16] + "' " + f + " />"],
                        e = ["x" === u.axis ? i[2] : i[0], "x" === u.axis ? i[3] : i[1], i[2], i[3]];
                ...
                g = function(n, t, i) {
                    var f = i ? r[0] + "_expanded" : "",
                        u = n.closest(".mCSBap_scrollTools");
                    "active" === t ? (n.toggleClass(r[0] + " " + f), u.toggleClass(r[1]), n[0]._draggable = n[0]._draggable ? 0 : 1) : n[0]._draggable || ("hide" === t ? (n.removeClass(r[0]), u.removeClass(r[1])) : (n.addClass(r[0]), u.addClass(r[1])))
                },
                ri = function() {
                    var h = n(this),
                        r = h.data(t),
                ...
                p = function() {
                    ...
                    if (s(r), ("x" !== u.axis && !i.overflowed[0] || "y" === u.axis && i.overflowed[0]) && (h[0].add(e).css("top", 0), f(r, "_resetY")), "y" !== u.axis && !i.overflowed[1] || "x" === u.axis && i.overflowed[1]) {
                        var o = dx = 0;
                        "rtl" === i.langDir && (o = c.width() - e.outerWidth(!1), dx = Math.abs(o / i.scrollRatio.x));
                        e.css("left", o);
                        h[1].css("left", dx);
                        f(r, "_resetX")
                    }
                ...
                ui = function() {
                    function u() {
                        e = setTimeout(function() {
                            n.event.special.mousewheel ? (clearTimeout(e), si.call(f[0])) : u()
                        }, 100)
                    }
                    var f = n(this),
                        r = f.data(t),
                        i = r.opt;
                    if (!r.bindEvents) {
                        if (fi.call(this), i.contentTouchScroll && ei.call(this), oi.call(this), i.mouseWheel.enable) {
                            var e;
                            u()
                        }
                        ci.call(this);
                        ai.call(this);
                        i.advanced.autoScrollOnFocus && li.call(this);
                        i.scrollButtons.enable && vi.call(this);
                        i.keyboard.enable && yi.call(this);
                        r.bindEvents = !0
                    }
                },
                nt = function() {
                    var f = n(this),
                        ...
                        u = i.opt,
                        o = t + "_" + i.idx,
                        s = ".mCSBap_" + i.idx + "_scrollbar",
                        e = n("#mCSBap_" + i.idx + ",#mCSBap_" + i.idx + "_container,#mCSBap_" + i.idx + "_container_wrapper," + s + " ." + r[12] + ",#mCSBap_" + i.idx + "_dragger_vertical,#mCSBap_" + i.idx + "_dragger_horizontal," + s + ">a"),
                        h = n("#mCSBap_" + i.idx + "_container");
                    ...
                    i.bindEvents && (n(document).add(n(!a() || top.document)).unbind("." + o), e.each(function() {
                        n(this).unbind("." + o)
                    }), clearTimeout(f[0]._focusTimeout), v(f[0], "_focusTimeout"), clearTimeout(i.sequential.step), v(i.sequential, "step"), clearTimeout(h[0].onCompleteTimeout), v(h[0], "onCompleteTimeout"), i.bindEvents = !1)
                },
                lt = function(i) {
                    var h = n(this),
                        u = h.data(t),
                    ...
                    "x" !== o.axis && (u.overflowed[0] && !i ? (e[0].add(s[0]).add(e[0].children("a")).css("display", "block"), f.removeClass(r[8] + " " + r[10])) : (o.alwaysShowScrollbar ? (2 !== o.alwaysShowScrollbar && s[0].css("display", "none"), f.removeClass(r[10])) : (e[0].css("display", "none"), f.addClass(r[10])), f.addClass(r[8])));
                    "y" !== o.axis && (u.overflowed[1] && !i ? (e[1].add(s[1]).add(e[1].children("a")).css("display", "block"), f.removeClass(r[9] + " " + r[11])) : (o.alwaysShowScrollbar ? (2 !== o.alwaysShowScrollbar && s[1].css("display", "none"), f.removeClass(r[11])) : (e[1].css("display", "none"), f.addClass(r[11])), f.addClass(r[9])));
                    u.overflowed[0] || u.overflowed[1] ? h.removeClass(r[5]) : h.addClass(r[5])
                },
                u = function(t) {
                    var e = t.type,
                        i = t.target.ownerDocument !== document && null !== frameElement ? [n(frameElement).offset().top, n(frameElement).offset().left] : null,
                        r = a() && t.target.ownerDocument !== top.document && null !== frameElement ? [n(t.view.frameElement).offset().top, n(t.view.frameElement).offset().left] : [0, 0];
                    switch (e) {
                        case "pointerdown":
                        case "MSPointerDown":
                        case "pointermove":
                    ...
                    function k(n, t, r, u) {
                        if (p[0].idleTimer = h.scrollInertia < 233 ? 250 : 0, i.attr("id") === y[1]) var o = "x",
                            s = (i[0].offsetLeft - t + u) * e.scrollRatio.x;
                        else var o = "y",
                            s = (i[0].offsetTop - n + r) * e.scrollRatio.y;
                        f(v, s.toString(), {
                            dir: o,
                            drag: !0
                        })
                    ...
                    var i, c, l, v = n(this),
                        ...
                        h = e.opt,
                        r = t + "_" + e.idx,
                        y = ["mCSBap_" + e.idx + "_dragger_vertical", "mCSBap_" + e.idx + "_dragger_horizontal"],
                        p = n("#mCSBap_" + e.idx + "_container"),
                        b = n("#" + y[0] + ",#" + y[1]),
                        d = h.advanced.releaseDraggableSelectors ? b.add(n(h.advanced.releaseDraggableSelectors)) : b,
                        nt = h.advanced.extraDraggableSelectors ? n(!a() || top.document).add(n(h.advanced.extraDraggableSelectors)) : n(!a() || top.document);
                    b.bind("contextmenu." + r, function(n) {
                        n.preventDefault()
                    }).bind("mousedown." + r + " touchstart." + r + " pointerdown." + r + " MSPointerDown." + r, function(t) {
                        if (t.stopImmediatePropagation(), t.preventDefault(), pt(t)) {
                            o = !0;
                            w && (document.onselectstart = function() {
                                return !1
                            });
                            at.call(p, !1);
                            s(v);
                            ...
                            var r = i.offset(),
                                ...
                                a = i.height() + r.top,
                                y = i.width() + r.left;
                            a > f && f > 0 && y > e && e > 0 && (c = f, l = e);
                            g(i, "active", h.autoExpandScrollbar)
                        }
                    }).bind("touchmove." + r, function(n) {
                    ...
                    n(document).add(nt).bind("mousemove." + r + " pointermove." + r + " MSPointerMove." + r, function(n) {
                        if (i) {
                            var t = i.offset(),
                                r = u(n)[0] - t.top,
                                f = u(n)[1] - t.left;
                    ...
                    }).add(d).bind("mouseup." + r + " touchend." + r + " pointerup." + r + " MSPointerUp." + r, function() {
                        i && (g(i, "active", h.autoExpandScrollbar), i = null);
                        o = !1;
                        w && (document.onselectstart = null);
                        at.call(p, !0)
                    })
                },
                ei = function() {
                    function at(n) {
                        if (!tt(n) || o || u(n)[2]) return void(c = 0);
                        c = 1;
                        it = 0;
                        rt = 0;
                        st = 1;
                    ...
                    function vt(n) {
                        if (tt(n) && !o && !u(n)[2] && (r.documentTouchScroll || n.preventDefault(), n.stopImmediatePropagation(), (!rt || it) && st)) {
                            gt = b();
                            var s = ut.offset(),
                                t = u(n)[0] - s.top,
                                f = u(n)[1] - s.left,
                                h = "mcsLinearOut";
                            if (et.push(t), ot.push(f), v[2] = Math.abs(u(n)[0] - v[0]), v[3] = Math.abs(u(n)[1] - v[1]), i.overflowed[0]) var c = ft[0].parent().height() - ft[0].height(),
                                l = k - t > 0 && t - k > -(c * i.scrollRatio.y) && (2 * v[3] < v[2] || "yx" === r.axis);
                            if (i.overflowed[1]) var a = ft[1].parent().width() - ft[1].width(),
                                y = d - f > 0 && f - d > -(a * i.scrollRatio.x) && (2 * v[2] < v[3] || "yx" === r.axis);
                            l || y ? (ii || n.preventDefault(), it = 1) : (rt = 1, g.addClass("mCS_touch_action"));
                            ii && n.preventDefault();
                            e = "yx" === r.axis ? [k - t, d - f] : "x" === r.axis ? [null, d - f] : [k - t, null];
                            w[0].idleTimer = 250;
                            i.overflowed[0] && nt(e[0], ni, h, "y", "all", !0);
                            i.overflowed[1] && nt(e[1], ni, h, "x", lt, !0)
                        }
                    }
                    ...
                    function pt(n) {
                        if (tt(n) && !o && !u(n)[2]) {
                            ...
                            if (!(ht - gt > 30)) {
                                ...
                                var v = "mcsEaseOut",
                                    s = 2.5 > h,
                                    p = s ? [et[et.length - 2], ot[ot.length - 2]] : [0, 0];
                                y = s ? [l - p[0], a - p[1]] : [l - bt, a - kt];
                                var t = [Math.abs(y[0]), Math.abs(y[1])];
                                h = s ? [Math.abs(y[0] / 4), Math.abs(y[1] / 4)] : [h, h];
                                var f = [Math.abs(w[0].offsetTop) - y[0] * wt(t[0] / h[0], h[0]), Math.abs(w[0].offsetLeft) - y[1] * wt(t[1] / h[1], h[1])];
                                e = "yx" === r.axis ? [f[0], f[1]] : "x" === r.axis ? [null, f[1]] : [f[0], null];
                                ct = [4 * t[0] + r.scrollInertia, 4 * t[1] + r.scrollInertia];
                                var k = parseInt(r.contentTouchScroll) || 0;
                                e[0] = t[0] > k ? e[0] : 0;
                                e[1] = t[1] > k ? e[1] : 0;
                                i.overflowed[0] && nt(e[0], ct[0], v, "y", lt, !1);
                                i.overflowed[1] && nt(e[1], ct[1], v, "x", lt, !1)
                            }
                        }
                    }
                    ...
                    var st, k, d, bt, kt, dt, gt, ht, y, h, e, ct, it, rt, g = n(this),
                        i = g.data(t),
                        r = i.opt,
                        l = t + "_" + i.idx,
                        ut = n("#mCSBap_" + i.idx),
                        w = n("#mCSBap_" + i.idx + "_container"),
                        ft = [n("#mCSBap_" + i.idx + "_dragger_vertical"), n("#mCSBap_" + i.idx + "_dragger_horizontal")],
                        et = [],
                        ot = [],
                        ni = 0,
                        lt = "yx" === r.axis ? "none" : "all",
                        v = [],
                        ti = w.find("iframe"),
                    ...
                    ti.length && ti.each(function() {
                        n(this).bind("load", function() {
                            a(this) && n(this.contentDocument || this.contentWindow.document).bind(p[0], function(n) {
                                at(n);
                                yt(n)
                            }).bind(p[1], function(n) {
                                vt(n)
                ...
                oi = function() {
                    function p() {
                        return i.getSelection ? i.getSelection().toString() : document.selection && "Control" != document.selection.type ? document.selection.createRange().text : 0
                    }

                    function r(n, t, i) {
                        a.type = i && f ? "stepped" : "stepless";
                        a.scrollAmount = 10;
                        ft(v, n, t, "mcsLinearOut", i ? 60 : null)
                    }
                    var f, v = n(this),
                        e = v.data(t),
                        y = e.opt,
                        a = e.sequential,
                        h = t + "_" + e.idx,
                        s = n("#mCSBap_" + e.idx + "_container"),
                        l = s.parent();
                    s.bind("mousedown." + h, function() {
                        c || f || (f = 1, o = !0)
                    }).add(document).bind("mousemove." + h, function(n) {
                        if (!c && f && p()) {
                            var o = s.offset(),
                                t = u(n)[0] - o.top + s[0].offsetTop,
                                i = u(n)[1] - o.left + s[0].offsetLeft;
                            t > 0 && t < l.height() && i > 0 && i < l.width() ? a.step && r("off", null, "stepped") : ("x" !== y.axis && e.overflowed[0] && (0 > t ? r("on", 38) : t > l.height() && r("on", 40)), "y" !== y.axis && e.overflowed[1] && (0 > i ? r("on", 37) : i > l.width() && r("on", 39)))
                        }
                    }).bind("mouseup." + h + " dragend." + h, function() {
                        c || (f && (f = 0, r("off", null)), o = !1)
                    })
                },
                si = function() {
                    function h(t, h) {
                        if (s(o), !hi(o, t.target)) {
                            var v = "auto" !== i.mouseWheel.deltaFactor ? parseInt(i.mouseWheel.deltaFactor) : w && t.deltaFactor < 100 ? 100 : t.deltaFactor || 100,
                                y = i.scrollInertia;
                            if ("x" === i.axis || "x" === i.mouseWheel.axis) var a = "x",
                                l = [Math.round(v * r.scrollRatio.x), parseInt(i.mouseWheel.scrollAmount)],
                                p = "auto" !== i.mouseWheel.scrollAmount ? l[1] : l[0] >= e.width() ? .9 * e.width() : l[0],
                                k = Math.abs(n("#mCSBap_" + r.idx + "_container")[0].offsetLeft),
                                b = u[1][0].offsetLeft,
                                d = u[1].parent().width() - u[1].width(),
                                c = "y" === i.mouseWheel.axis ? t.deltaY || h : t.deltaX;
                            else var a = "y",
                                l = [Math.round(v * r.scrollRatio.y), parseInt(i.mouseWheel.scrollAmount)],
                                p = "auto" !== i.mouseWheel.scrollAmount ? l[1] : l[0] >= e.height() ? .9 * e.height() : l[0],
                                k = Math.abs(n("#mCSBap_" + r.idx + "_container")[0].offsetTop),
                                b = u[0][0].offsetTop,
                                d = u[0].parent().height() - u[0].height(),
                                c = t.deltaY || h;
                            ("y" !== a || r.overflowed[0]) && ("x" !== a || r.overflowed[1]) && ((i.mouseWheel.invert || t.webkitDirectionInvertedFromDevice) && (c = -c), i.mouseWheel.normalizeDelta && (c = 0 > c ? -1 : 1), (c > 0 && 0 !== b || 0 > c && b !== d || i.mouseWheel.preventDefault) && (t.stopImmediatePropagation(), t.preventDefault()), t.deltaFactor < 5 && !i.mouseWheel.normalizeDelta && (p = t.deltaFactor, y = 17), f(o, (k - c * p).toString(), {
                                dir: a,
                                dur: y
                            }))
                        }
                    ...
                    if (n(this).data(t)) {
                        var o = n(this),
                            ...
                            c = t + "_" + r.idx,
                            e = n("#mCSBap_" + r.idx),
                            u = [n("#mCSBap_" + r.idx + "_dragger_vertical"), n("#mCSBap_" + r.idx + "_dragger_horizontal")],
                            l = n("#mCSBap_" + r.idx + "_container").find("iframe");
                        l.length && l.each(function() {
                            n(this).bind("load", function() {
                                a(this) && n(this.contentDocument || this.contentWindow.document).bind("mousewheel." + c, function(n, t) {
                                    h(n, t)
                                })
                            })
                        });
                ...
                a = function(t) {
                    var r = !1,
                        i = !1,
                        u = null;
                    if (void 0 === t ? i = "#empty" : void 0 !== n(t).attr("id") && (i = n(t).attr("id")), i !== !1 && void 0 !== ut[i]) return ut[i];
                    if (t) {
                        try {
                ...
                ci = function() {
                    var e, h = n(this),
                        u = h.data(t),
                        i = t + "_" + u.idx,
                        c = n("#mCSBap_" + u.idx + "_container"),
                        l = c.parent(),
                        a = n(".mCSBap_" + u.idx + "_scrollbar ." + r[12]);
                    a.bind("mousedown." + i + " touchstart." + i + " pointerdown." + i + " MSPointerDown." + i, function(t) {
                        o = !0;
                        n(t.target).hasClass("mCSBap_dragger") || (e = 1)
                    }).bind("touchend." + i + " pointerup." + i + " MSPointerUp." + i, function() {
                        o = !1
                    }).bind("click." + i, function(t) {
                        if (e && (e = 0, n(t.target).hasClass(r[12]) || n(t.target).hasClass("mCSBap_draggerRail"))) {
                            s(h);
                            var i = n(this),
                                o = i.find(".mCSBap_dragger");
                            if (i.parent(".mCSBap_scrollTools_horizontal").length > 0) {
                                if (!u.overflowed[1]) return;
                                var v = "x",
                                    a = t.pageX > o.offset().left ? -1 : 1,
                                    y = Math.abs(c[0].offsetLeft) - a * .9 * l.width()
                            } else {
                                if (!u.overflowed[0]) return;
                                var v = "y",
                                    a = t.pageY > o.offset().top ? -1 : 1,
                ...
                li = function() {
                    var i = n(this),
                        ...
                        u = o.opt,
                        c = t + "_" + o.idx,
                        r = n("#mCSBap_" + o.idx + "_container"),
                        h = r.parent();
                    r.bind("focusin." + c, function() {
                        var t = n(document.activeElement),
                            c = r.find(".mCustomScrollBox").length,
                            o = 0;
                        t.is(u.advanced.autoScrollOnFocus) && (s(i), clearTimeout(i[0]._focusTimeout), i[0]._focusTimer = c ? (o + 17) * c : 0, i[0]._focusTimeout = setTimeout(function() {
                            var n = [e(t)[0], e(t)[1]],
                                s = [r[0].offsetTop, r[0].offsetLeft],
                                c = [s[0] + n[0] >= 0 && s[0] + n[0] < h.height() - t.outerHeight(!1), s[1] + n[1] >= 0 && s[0] + n[1] < h.width() - t.outerWidth(!1)],
                                l = "yx" !== u.axis || c[0] || c[1] ? "all" : "none";
                            "x" === u.axis || c[0] || f(i, n[0].toString(), {
                                dir: "y",
                                scrollEasing: "mcsEaseInOut",
                                overwrite: l,
                                dur: o
                            });
                            "y" === u.axis || c[1] || f(i, n[1].toString(), {
                                dir: "x",
                                scrollEasing: "mcsEaseInOut",
                                overwrite: l,
                                dur: o
                ...
                vi = function() {
                    ...
                    h.bind("contextmenu." + i, function(n) {
                        ...
                        function i(n, t) {
                            u.scrollAmount = e.scrollButtons.scrollAmount;
                            ft(f, n, t)
                        }
                        if (t.preventDefault(), pt(t)) {
                            var s = n(this).attr("class");
                            switch (u.type = e.scrollButtons.scrollType, t.type) {
                                case "mousedown":
                                case "touchstart":
                                case "pointerdown":
                                case "MSPointerDown":
                ...
                yi = function() {
                    function l(t) {
                        ...
                        switch (t.type) {
                            case "blur":
                                i.tweenRunning && o.dir && l("off", null);
                                break;
                            case "keydown":
                            case "keyup":
                                ...
                                if ("x" !== r.axis && (38 === c || 40 === c) || "y" !== r.axis && (37 === c || 39 === c)) {
                                    ...
                                    if ((i.overflowed[0] || i.overflowed[1]) && (t.preventDefault(), t.stopImmediatePropagation()), "keyup" === t.type) {
                                        ...
                                        if ("x" === r.axis || "yx" === r.axis && i.overflowed[1] && !i.overflowed[0]) var p = "x",
                                            w = Math.abs(u[0].offsetLeft) - y * .9 * h.width();
                                        else var p = "y",
                                            w = Math.abs(u[0].offsetTop) - y * .9 * h.height();
                                        f(e, w.toString(), {
                                            dir: p,
                                            scrollEasing: "mcsEaseInOut"
                                        })
                                    ...
                                    if ("x" === r.axis || "yx" === r.axis && i.overflowed[1] && !i.overflowed[0]) var p = "x",
                                        w = 35 === c ? Math.abs(h.width() - u.outerWidth(!1)) : 0;
                                    else var p = "y",
                                        w = 35 === c ? Math.abs(h.height() - u.outerHeight(!1)) : 0;
                                    f(e, w.toString(), {
                                        dir: p,
                                        scrollEasing: "mcsEaseInOut"
                                    })
                ...
                ft = function(i, u, e, o, h) {
                    function y(n) {
                        l.snapAmount && (c.scrollAmount = l.snapAmount instanceof Array ? "x" === c.dir[0] ? l.snapAmount[1] : l.snapAmount[0] : l.snapAmount);
                        var r = "stepped" !== c.type,
                            u = h ? h : n ? r ? k / 1.5 : d : 1e3 / 60,
                            e = n ? r ? 7.5 : 40 : 2.5,
                            t = [Math.abs(p[0].offsetTop), Math.abs(p[0].offsetLeft)],
                            s = [a.scrollRatio.y > 10 ? 10 : a.scrollRatio.y, a.scrollRatio.x > 10 ? 10 : a.scrollRatio.x],
                            w = "x" === c.dir[0] ? t[1] + c.dir[1] * s[1] * e : t[0] + c.dir[1] * s[0] * e,
                            b = "x" === c.dir[0] ? t[1] + c.dir[1] * parseInt(c.scrollAmount) : t[0] + c.dir[1] * parseInt(c.scrollAmount),
                            v = "auto" !== c.scrollAmount ? b : w,
                            g = o ? o : n ? r ? "mcsLinearOut" : "mcsEaseInOut" : "mcsLinear",
                            nt = !!n;
                        return n && 17 > u && (v = "x" === c.dir[0] ? t[1] : t[0]), f(i, v.toString(), {
                            dir: c.dir[0],
                            scrollEasing: g,
                            dur: u,
                            onComplete: nt
                    ...
                    var a = i.data(t),
                        l = a.opt,
                        c = a.sequential,
                        p = n("#mCSBap_" + a.idx + "_container"),
                        w = "stepped" === c.type,
                        k = l.scrollInertia < 26 ? 26 : l.scrollInertia,
                        d = l.scrollInertia < 1 ? 17 : l.scrollInertia;
                    switch (u) {
                        case "on":
                            if (c.dir = [e === r[16] || e === r[15] || 39 === e || 37 === e ? "x" : "y", e === r[13] || e === r[15] || 38 === e || 37 === e ? -1 : 1], s(i), it(e) && "stepped" === c.type) return;
                            y(w);
                            break;
                        case "off":
                            b();
                            (w || a.tweenRunning && c.dir) && y(!0)
                    }
                },
                et = function(i) {
                    ...
                    if (null != i && "undefined" != typeof i) {
                        ...
                        switch (y) {
                            case "function":
                                return i();
                            case "object":
                                var f = i.jquery ? i : n(i);
                                return f.length ? "x" === r ? e(f)[1] : e(f)[0] : void 0;
                            case "string":
                            case "number":
                                if (it(i)) return Math.abs(i);
                                ...
                                if (-1 !== i.indexOf("px") && it(i.split("px")[0])) return Math.abs(i.split("px")[0]);
                                ...
                                if ("first" === i || "last" === i) {
                                    var f = u.find(":" + i);
                                    return "x" === r ? e(f)[1] : e(f)[0]
                                }
                                return n(i).length ? "x" === r ? e(n(i))[1] : e(n(i))[0] : (u.css(w, i), void h.update.call(null, s[0]))
                        }
                    }
                },
                ot = function(i) {
                    ...
                    function l(t) {
                        ...
                        if (n(t).hasClass(r[2])) return void s();
                        var i = new Image;
                        i.onload = u(i, f);
                        i.src = t.src
                    }
                    ...
                    function s(n) {
                        ...
                        h.update.call(null, o[0], n)
                    }
                    var o = n(this),
                        u = o.data(t),
                        f = u.opt,
                        e = n("#mCSBap_" + u.idx + "_container");
                    return i ? (clearTimeout(e[0].autoUpdate), void v(e[0], "autoUpdate")) : void c()
                },
                pi = function(n, t, i) {
                ...
                f = function(i, r, u) {
                    ...
                    var f = i.data(t),
                        ...
                        b = o.parent(),
                        d = e.callbacks.onTotalScrollOffset ? et.call(i, e.callbacks.onTotalScrollOffset) : [0, 0],
                        nt = e.callbacks.onTotalScrollBackOffset ? et.call(i, e.callbacks.onTotalScrollBackOffset) : [0, 0];
                    if (f.trigger = u.trigger, 0 === b.scrollTop() && 0 === b.scrollLeft() || (n(".mCSBap_" + f.idx + "_scrollbar").css("visibility", "visible"), b.scrollTop(0).scrollLeft(0)), "_resetY" !== r || f.contentReset.y || (h("onOverflowYNone") && e.callbacks.onOverflowYNone.call(i[0]), f.contentReset.y = 1), "_resetX" !== r || f.contentReset.x || (h("onOverflowXNone") && e.callbacks.onOverflowXNone.call(i[0]), f.contentReset.x = 1), "_resetY" !== r && "_resetX" !== r) {
                        ...
                        yt(c[0], tt, Math.round(s[1]), k[1], u.scrollEasing);
                        !f.tweenRunning && (0 === w && s[0] >= 0 || w === l[0] && s[0] <= l[0]) || yt(o[0], tt, Math.round(s[0]), k[0], u.scrollEasing, u.overwrite, {
                            onStart: function() {
                                u.callbacks && u.onStart && !f.tweenRunning && (h("onScrollStart") && (a(), e.callbacks.onScrollStart.call(i[0])), f.tweenRunning = !0, g(c), f.cbOffsets = it())
                            },
                            onUpdate: function() {
                            ...
                            onComplete: function() {
                                if (u.callbacks && u.onComplete) {
                                    ...
                                    o[0].onCompleteTimeout = setTimeout(function() {
                                        ...
                                        h("onTotalScroll") && s[1] >= l[1] - ft && f.cbOffsets[0] && (a(), e.callbacks.onTotalScroll.call(i[0]));
                ...
                yt = function(n, t, r, u, f, e, o) {
                    function v() {
                        s.stop || (h || g.call(), h = b() - it, y(), h >= s.time && (s.time = h > s.time ? h + c - (h - s.time) : h + c - 1, s.time < h + 1 && (s.time = h + 1)), s.time < u ? s.id = l(v) : tt.call())
                    }

                    function y() {
                        u > 0 ? (s.currVal = d(s.time, a, rt, u, f), p[t] = Math.round(s.currVal) + "px") : p[t] = r + "px";
                        nt.call()
                    }
                    ...
                    function w() {
                        c = 1e3 / 60;
                        s.time = h + c;
                        l = i.requestAnimationFrame ? i.requestAnimationFrame : function(n) {
                            return y(), setTimeout(n, .01)
                        };
                        s.id = l(v)
                    }

                    function k() {
                        null != s.id && (i.requestAnimationFrame ? i.cancelAnimationFrame(s.id) : clearTimeout(s.id), s.id = null)
                    }
                    ...
                    var c, l, o = o || {},
                        g = o.onStart || function() {},
                        nt = o.onUpdate || function() {},
                        tt = o.onComplete || function() {},
                        it = b(),
                        h = 0,
                        a = n.offsetTop,
                        p = n.style,
                        s = n._mTween[t];
                    "left" === t && (a = n.offsetLeft);
                    var rt = r - a;
                    s.stop = 0;
                    "none" !== e && k();
                    w()
                ...
                b = function() {
                    return i.performance && i.performance.now ? i.performance.now() : i.performance && i.performance.webkitNow ? i.performance.webkitNow() : Date.now ? Date.now() : (new Date).getTime()
                },
                wi = function() {
                    var n = this;
                    n._mTween || (n._mTween = {
                    ...
                    for (var u = ["top", "left"], r = 0; r < u.length; r++) {
                        var t = u[r];
                        n._mTween[t].id && (i.requestAnimationFrame ? i.cancelAnimationFrame(n._mTween[t].id) : clearTimeout(n._mTween[t].id), n._mTween[t].id = null, n._mTween[t].stop = 1)
                    }
                },
                v = function(n, t) {
                    try {
            ...
            n.fn[l] = function(t) {
                return h[t] ? h[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void n.error("Method " + t + " does not exist") : h.init.apply(this, arguments)
            };
            n[l] = function(t) {
                return h[t] ? h[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void n.error("Method " + t + " does not exist") : h.init.apply(this, arguments)
            };
            ...
            n(i).bind("load", function() {
                ...
                n.extend(n.expr[":"], {
                    ...
                    mcsInSight: n.expr[":"].mcsInSight || function(t, i, r) {
                        ...
                        if (c.length) return f = [h.outerHeight(!1), h.outerWidth(!1)], o = [c[0].offsetTop + e(h)[0], c[0].offsetLeft + e(h)[1]], u = [c.parent()[0].offsetHeight, c.parent()[0].offsetWidth], s = [f[0] < u[0] ? l[0] : l[1], f[1] < u[1] ? l[0] : l[1]], o[0] - u[0] * s[0][0] < 0 && o[0] + f[0] - u[0] * s[0][1] >= 0 && o[1] - u[1] * s[1][0] < 0 && o[1] + f[1] - u[1] * s[1][1] >= 0
                    },
    ...
    (function(t) {
        var o = {
            init: function(n, i) {
                ...
                r.o = t.extend({}, n);
                r.n = {};
                r.n.container = t(this.elem);
                r.o.rid = r.n.container.attr("id").match(/^ajaxsearchlite(.*)/)[1];
                r.o.id = r.n.container.attr("id").match(/^ajaxsearchlite(.*)/)[1];
                r.n.probox = t(".probox", r.n.container);
                r.n.proinput = t(".proinput", r.n.container);
                r.n.text = t(".proinput input.orig", r.n.container);
                r.n.textAutocomplete = t(".proinput input.autocomplete", r.n.container);
                r.n.loading = t(".proinput .loading", r.n.container);
                r.n.proloading = t(".proloading", r.n.container);
                r.n.proclose = t(".proclose", r.n.container);
                r.n.promagnifier = t(".promagnifier", r.n.container);
                r.n.prosettings = t(".prosettings", r.n.container);
                r.n.searchsettings = t("#ajaxsearchlitesettings" + r.o.rid);
                r.n.resultsDiv = t("#ajaxsearchliteres" + r.o.rid);
                r.n.hiddenContainer = t("#asl_hidden_data");
                r.n.aslItemOverlay = t(".asl_item_overlay", r.n.hiddenContainer);
                r.resizeTimeout = null;
                r.n.showmore = t(".showmore", r.n.resultsDiv);
                r.n.items = t(".item", r.n.resultsDiv);
                r.n.results = t(".results", r.n.resultsDiv);
                r.n.resdrg = t(".resdrg", r.n.resultsDiv);
                r.il = {
                    columns: 3,
                    itemsPerPage: 6
                };
                ...
                r.settScroll = null;
                r.n.resultsAppend = t("#wpdreams_asl_results_" + r.o.id);
                r.currentPage = 1;
                r.isotopic = null;
                ...
                return r.filterFns = {
                    number: function() {
                        for (var n = t(this).parent(); !n.hasClass("isotopic");) n = n.parent();
                        var i = t(this).attr("data-itemnum"),
                            u = r.currentPage,
                            f = r.il.itemsPerPage;
                        return parseInt(i, 10) < f * u && parseInt(i, 10) >= f * (u - 1)
                    }
                }, r.disableMobileScroll = !1, r.n.searchsettings.detach().appendTo("body"), r.o.resultsposition == "hover" ? r.n.resultsDiv.detach().appendTo("body") : r.n.resultsAppend.length > 0 && r.n.resultsDiv.detach().appendTo(r.n.resultsAppend), t("fieldset", r.n.searchsettings).each(function() {
                    t(".asl_option:not(.hiddend)", this).last().addClass("asl-o-last")
                }), r.createVerticalScroll(), s() && r.n.container.addClass("asl_msie"), r.initSettingsAnimations(), r.initResultsAnimations(), r.initEvents(), r.initEtc(), this
            },
            duplicateCheck: function() {
                var i = this,
                    n = {};
                t("div[id*=ajaxsearchlite]").each(function() {
                    n.hasOwnProperty(this.id) ? t(this).remove() : n[this.id] = "true"
                })
            },
            ...
            createVerticalScroll: function() {
                var n = this;
                n.is_scroll && (n.scroll = n.n.results.mCustScr({
                    ...
                    callbacks: {
                        onScroll: function() {
                            if (!u()) {
                                var s = parseInt(t(".mCSBap_container", n.n.results).position().top),
                                    h = t(".mCSBap_container .resdrg").children(),
                                    f = 0,
                                    o = 3e3,
                                    r = 4e3,
                                    c = 1e4,
                                    ...
                                    i = null;
                                h.each(function() {
                                    r = Math.abs(Math.abs(s) - f);
                                    r < o && (c = r, e = f, i = t(this));
                                    f += t(this).outerHeight(!0);
                                    o = r
                                });
                                i.hasClass("group") && (e = e + (i.outerHeight(!0) - i.outerHeight(!1)));
                                n.scroll.mCustScr("scrollTo", i, {
                                    scrollInertia: 200,
                                    callbacks: !1
                                })
                            }
            ...
            initEvents: function() {
                var r = this;
                r.n.text.click(function() {
                    t(this).focus()
                });
                t(r.n.text.parent()).submit(function(t) {
                    if (t.preventDefault(), u())
                        if (r.o.redirect_on_enter) {
                            var i = n.Event("keyup");
                            i.keyCode = i.which = 13;
                            r.n.text.trigger(i)
                        } else r.search(), document.activeElement.blur();
                    else r.search()
                });
                r.n.text.click(function() {
                    r.firstClick && (t(this).val(""), r.firstClick = !1)
                });
                r.n.resultsDiv.css({
                    opacity: 0
                });
                t(document).bind("click touchend", function() {
                    (r.hideSettings(), r.opened != !1 && r.o.closeOnDocClick == 1) && r.hideResults()
                });
                r.n.proclose.bind("click touchend", function() {
                    r.opened != !1 && (r.n.text.val(""), r.n.textAutocomplete.val(""), r.hideResults(), r.n.text.focus())
                });
                t(r.elem).bind("click touchend", function(n) {
                    n.stopImmediatePropagation()
                });
                r.n.resultsDiv.bind("click touchend", function(n) {
                    n.stopImmediatePropagation()
                });
                r.n.searchsettings.bind("click touchend", function(n) {
                    n.stopImmediatePropagation()
                });
                r.n.prosettings.on("click", function() {
                    r.n.prosettings.data("opened") == 0 ? r.showSettings() : r.hideSettings()
                });
                var f;
                ...
                c() && u() && h() && parseInt(r.n.text.css("font-size")) < 16 && (r.n.text.data("fontSize", r.n.text.css("font-size")).css("font-size", "16px"), r.n.textAutocomplete.css("font-size", "16px"), t("<style>#ajaxsearchlite" + r.o.rid + " input.orig::-webkit-input-placeholder{font-size: 16px !important;}<\/style>").appendTo("head"));
                r.initNavigationEvent();
                t(i).trigger("resize");
                t(i).trigger("scroll");
                r.initMagnifierEvent();
                r.initAutocompleteEvent();
                r.initFacetEvents()
            },
            initEtc: function() {
                var n = this,
                    i = null;
                t("div.asl_option", n.n.searchsettings).on("mouseup touchend", function() {
                    t('input[type="checkbox"]', this).prop("checked", !t('input[type="checkbox"]', this).prop("checked"));
                    clearTimeout(i);
                    var n = this;
                    i = setTimeout(function() {
                        t('input[type="checkbox"]', n).trigger("asl_chbx_change")
                    }, 50)
                });
                t("div.asl_option label", n.n.searchsettings).click(function(n) {
                    n.preventDefault()
                })
            },
            initNavigationEvent: function() {
                var n = this;
                t(n.n.resultsDiv).on("mouseenter", ".item", function() {
                    t(".item", n.n.resultsDiv).removeClass("hovered");
                    t(this).addClass("hovered")
                });
                t(n.n.resultsDiv).on("mouseleave", ".item", function() {
                    t(".item", n.n.resultsDiv).removeClass("hovered")
                });
                t(document).keydown(function(r) {
                    if (i.event) var u = i.event.keyCode,
                        f = i.event.type;
                    else if (r) var u = r.which,
                        f = r.type;
                    t(".item", n.n.resultsDiv).length > 0 && n.n.resultsDiv.css("display") != "none" && (u == 40 && (r.stopPropagation(), r.preventDefault(), n.n.text.blur(), n.post != null && n.post.abort(), t(".item.hovered", n.n.resultsDiv).length == 0 ? t(".item", n.n.resultsDiv).first().addClass("hovered") : t(".item.hovered", n.n.resultsDiv).removeClass("hovered").next().next(".item").addClass("hovered"), n.is_scroll && n.scroll.mCustScr("scrollTo", ".resdrg .item.hovered", {
                        scrollInertia: 200,
                        callbacks: !1
                    })), u == 38 && (r.stopPropagation(), r.preventDefault(), n.n.text.blur(), n.post != null && n.post.abort(), t(".item.hovered", n.n.resultsDiv).length == 0 ? t(".item", n.n.resultsDiv).last().addClass("hovered") : t(".item.hovered", n.n.resultsDiv).removeClass("hovered").prev().prev(".item").addClass("hovered"), n.is_scroll && n.scroll.mCustScr("scrollTo", ".resdrg .item.hovered", {
                        scrollInertia: 200,
                        callbacks: !1
                    })), u == 13 && t(".item.hovered", n.n.resultsDiv).length > 0 && (r.stopPropagation(), r.preventDefault(), t(".item.hovered a.asl_res_url", n.n.resultsDiv).get(0).click()))
                })
            },
            initMagnifierEvent: function() {
                var n = this,
                    u;
                n.n.promagnifier.add(n.n.text).bind("click keyup", function(o) {
                    i.event ? (n.keycode = i.event.keyCode, n.ktype = i.event.type) : o && (n.keycode = o.which, n.ktype = o.type);
                    var s = t(this).hasClass("orig");
                    if (n.n.text.val().length < n.o.charcount) {
                        n.n.proloading.css("display", "none");
                        n.hideResults();
                        n.post != null && n.post.abort();
                        clearTimeout(u);
                        return
                    }
                    if (!s && n.o.redirectonclick == 1 && n.ktype == "click" && n.o.redirectClickTo != "first_result" || s && n.o.redirect_on_enter == 1 && n.ktype == "keyup" && n.keycode == 13 && n.o.redirectEnterTo != "first_result") {
                        var c = n.ktype == "click" ? n.o.redirectClickTo : n.o.redirectEnterTo;
                        if (c == "results_page") var h = "?s=" + r(n.n.text.val());
                        else if (c == "woo_results_page") var h = "?post_type=product&s=" + r(n.n.text.val());
                        else var h = n.o.redirect_url.replace("{phrase}", r(n.n.text.val()));
                        n.o.overridewpdefault ? n.o.override_method == "post" ? f(n.o.homeurl + h, "post", {
                            asl_active: 1,
                            p_asl_data: t("form", n.n.searchsettings).serialize()
                        }) : location.href = n.o.homeurl + h + "&asl_active=1&p_asid=" + n.o.id + "&p_asl_data=" + e.encode(t("form", n.n.searchsettings).serialize()) : f(n.o.homeurl + h, "post", {
                            np_asl_data: t("form", n.n.searchsettings).serialize()
                        });
                        n.n.proloading.css("display", "none");
                        n.hideResults();
                        n.post != null && n.post.abort();
                    ...
                    if ((!(n.keycode >= 37) || !(n.keycode <= 40)) && (!(n.keycode >= 112) || !(n.keycode <= 123))) {
                        if (s && n.ktype == "click" || n.keycode == 32) {
                            t("form", n.n.searchsettings).serialize() + n.n.text.val().trim() == n.lastSuccesfulSearch && (n.n.proclose.css("display", "block"), n.resultsOpened || n.showResults());
                            return
                        }
                        t(this).hasClass("orig") && n.ktype == "click" || (n.o.triggeronclick != 0 || n.ktype != "click") && (n.o.triggerontype != 0 || n.ktype != "keyup") && (n.post != null && n.post.abort(), clearTimeout(u), n.hideLoader(), u = setTimeout(function() {
                            t("form", n.n.searchsettings).serialize() + n.n.text.val().trim() != n.lastSuccesfulSearch ? n.search() : (n.n.proclose.css("display", "block"), n.resultsOpened || n.showResults())
                        }, 250))
                    }
                })
            },
            initFacetEvents: function() {
                var n = this,
                    i = null;
                if (n.o.trigger_on_facet_change == 1) {
                    t("input[type!=checkbox], select", n.n.searchsettings).on("change slidechange", function() {
                        n.n.text.val().length < n.o.charcount || (n.post != null && n.post.abort(), clearTimeout(i), i = setTimeout(function() {
                            n.search()
                        }, 50))
                    });
                    t("input[type=checkbox]", n.n.searchsettings).on("asl_chbx_change", function() {
                        n.n.text.val().length < n.o.charcount || (n.post != null && n.post.abort(), clearTimeout(i), i = setTimeout(function() {
                            n.search()
                        }, 50))
                    })
            ...
            destroy: function() {
                return this.each(function() {
                    var n = t.extend({}, this, o);
                    t(i).unbind(n)
                })
            },
            searchfor: function(n) {
                t(".proinput input", this).val(n).trigger("keyup")
            },
            initAutocompleteEvent: function() {
                var n = this;
                n.o.autocomplete.enabled != 1 || u() || n.n.text.keyup(function(r) {
                    i.event ? (n.keycode = i.event.keyCode, n.ktype = i.event.type) : r && (n.keycode = r.which, n.ktype = r.type);
                    var u = 39;
                    t("body").hasClass("rtl") && (u = 37);
                    n.keycode == u && n.n.textAutocomplete.val() != "" ? (r.preventDefault(), n.n.text.val(n.n.textAutocomplete.val()), n.post != null && n.post.abort(), n.search()) : (n.postAuto != null && n.postAuto.abort(), n.autocompleteGoogleOnly())
                })
            },
            autocompleteGoogleOnly: function() {
                var n = this,
                    i = n.n.text.val();
                if (n.n.text.val() == "") {
                    n.n.textAutocomplete.val("");
                    return
                }
                var r = n.n.textAutocomplete.val();
                (r == "" || r.indexOf(i) != 0) && (n.n.textAutocomplete.val(""), t.ajax({
                    url: "https://clients1.google.com/complete/search",
                    dataType: "jsonp",
                    data: {
                        q: i,
                        hl: n.o.autocomplete.lang,
                        nolabels: "t",
                        client: "hp",
                        ds: ""
                    },
                    success: function(r) {
                        r[1].length > 0 && (response = r[1][0][0].replace(/(<([^>]+)>)/ig, ""), response = t("<textarea />").html(response).text(), response = response.substr(i.length), n.n.textAutocomplete.val(i + response))
                    }
                }))
            },
            search: function() {
                var n = this;
                if ((!n.searching || !0) && !(n.n.text.val().length < n.o.charcount)) {
                    n.searching = !0;
                    n.n.proloading.css({
                        display: "block"
                    });
                    ...
                    var i = {
                        ...
                        aslp: n.n.text.val(),
                        asid: n.o.id,
                        options: t("form", n.n.searchsettings).serialize()
                    };
                    if (JSON.stringify(i) === JSON.stringify(n.lastSearchData)) return n.resultsOpened || n.showResults(), n.hideLoader(), !1;
                    n.analytics(n.n.text.val());
                    n.post = t.post(ASL.ajaxurl, i, function(u) {
                        if (u = u.replace(/^\s*[\r\n]/gm, ""), u = u.match(/!!ASLSTART!!(.*[\s\S]*)!!ASLEND!!/)[1], n.n.resdrg.html(""), n.n.resdrg.html(u), t(".asl_keyword", n.n.resdrg).bind("click", function() {
                                n.n.text.val(t(this).html());
                                t("input.orig", n.n.container).val(t(this).html()).keydown();
                                t("form", n.n.container).trigger("submit", "ajax");
                                n.search()
                            }), n.n.items = t(".item", n.n.resultsDiv), t(".asl_res_url", n.n.resultsDiv).length > 0 && n.o.redirectonclick == 1 && n.ktype == "click" && n.o.redirectClickTo != "results_page" || n.o.redirect_on_enter == 1 && n.ktype == "keyup" && n.keycode == 13 && n.o.redirectEnterTo != "results_page") return location.href = t(t(".asl_res_url", n.n.resultsDiv).get(0)).attr("href"), !1;
                        if (n.hideLoader(), n.showResults(), n.scrollToResults(), n.lastSuccesfulSearch = t("form", n.n.searchsettings).serialize() + n.n.text.val().trim(), n.lastSearchData = i, n.n.items.length == 0) n.n.showmore != null && n.n.showmore.css("display", "none");
                        else if (n.n.showmore != null) {
                            n.n.showmore.css("display", "block");
                            t("a", n.n.showmore).off();
                            t("a", n.n.showmore).on("click", function() {
                                var u = n.o.redirectClickTo,
                                    i = "?s=" + r(n.n.text.val());
                                i = u == "results_page" ? "?s=" + r(n.n.text.val()) : u == "woo_results_page" ? "?post_type=product&s=" + r(n.n.text.val()) : n.o.redirect_url.replace("{phrase}", r(n.n.text.val()));
                                n.o.overridewpdefault ? n.o.override_method == "post" ? f(n.o.homeurl + i, "post", {
                                    asl_active: 1,
                                    p_asl_data: t("form", n.n.searchsettings).serialize()
                                }) : location.href = n.o.homeurl + i + "&asl_active=1&p_asid=" + n.o.id + "&p_asl_data=" + e.encode(t("form", n.n.searchsettings).serialize()) : f(n.o.homeurl + i, "post", {
                                    np_asl_data: t("form", n.n.searchsettings).serialize()
                                })
                            })
                        }
            ...
            scrollToResults: function() {
                if (($this = this, this.o.scrollToResults == 1) && !this.$elem.parent().hasClass("asl_preview_data")) {
                    if ($this.o.resultsposition == "hover") var n = $this.n.probox.offset().top - 20;
                    else var n = $this.n.resultsDiv.offset().top - 20;
                    t("#wpadminbar").length > 0 && (n -= t("#wpadminbar").height());
                    n = n < 0 ? 0 : n;
                    t("body, html").animate({
                        scrollTop: n
                    }, {
            ...
            showVerticalResults: function() {
                var n = this;
                if (n.showResultsBox(), n.n.items.length > 0) {
                    var f = n.n.items.length < n.o.itemscount ? n.n.items.length : n.o.itemscount,
                        o = t(".group", n.n.resultsDiv);
                    if (n.n.items.length <= n.o.itemscount) n.n.results.css({
                        height: "auto"
                    });
                    else {
                        n.n.results.css({
                        ...
                        n.is_scroll && n.scroll.mCustScr("update");
                        n.resize();
                        var r = 0,
                            u = 0;
                        n.n.items.each(function() {
                            u += t(this).outerHeight(!0);
                            r++
                        });
                        r = r < 1 ? 1 : r;
                        u = u / r * f;
                    ...
                    if (i.sscroll = n.scroll, n.is_scroll && (n.scroll.mCustScr("disable", !0), n.scroll.mCustScr("update")), n.resize(), n.is_scroll && n.scroll.mCustScr("scrollTo", 0), n.o.highlight == 1) {
                        var e = n.o.highlightwholewords == 1 ? !0 : !1;
                        t("div.item", n.n.resultsDiv).highlight(n.n.text.val().split(" "), {
                            element: "span",
                ...
                if (n.resize(), n.n.items.length == 0) {
                    var u = t(".nores", n.n.results).outerHeight(!0) > n.o.resultitemheight ? n.o.resultitemheight : t(".nores", n.n.results).outerHeight(!0);
                    n.is_scroll ? (n.n.results.css({
                        height: 11110
                    }), n.scroll.mCustScr("update"), n.n.results.css({
                        height: "auto"
                    })) : n.n.results.css({
                        height: "auto"
                    })
            ...
            hideVerticalResults: function() {
                var n = this;
                n.disableMobileScroll = !1;
                n.n.resultsDiv.animate({
                    opacity: 0,
                    height: 0
                }, {
                    duration: 120,
            ...
            showSettings: function() {
                var n = this;
                n.scrolling(!0);
                n.n.searchsettings.css(n.settAnim.showCSS);
                n.n.searchsettings.removeClass(n.settAnim.hideClass).addClass(n.settAnim.showClass);
                n.settScroll == null && n.is_scroll && (n.settScroll = t(".asl_sett_scroll", n.n.searchsettings).mCustScr({
                    contentTouchScroll: !0
                }));
                n.n.prosettings.data("opened", 1)
            },
            ...
            cleanUp: function() {
                var n = this;
                t(".searchsettings", n.n.container).length > 0 && (t("body>#ajaxsearchlitesettings" + n.o.rid).remove(), t("body>#ajaxsearchliteres" + n.o.rid).remove())
            },
            resize: function() {
                var n = this,
                    i = 0;
                if (t("body").css("position") != "static" && (i = t("body").offset().top), s() && 0 && (n.n.proinput.css({
                        width: n.n.probox.width() - 8 - (n.n.proinput.outerWidth(!1) - n.n.proinput.width()) - n.n.proloading.outerWidth(!0) - n.n.prosettings.outerWidth(!0) - n.n.promagnifier.outerWidth(!0) - 10
                    }), n.n.text.css({
                        width: n.n.proinput.width() - 2 + n.n.proloading.outerWidth(!0),
                        position: "absolute",
                        zIndex: 2
                    }), n.n.textAutocomplete.css({
                        width: n.n.proinput.width() - 2 + n.n.proloading.outerWidth(!0),
                        opacity: .25,
                        zIndex: 1
                    })), n.n.prosettings.attr("opened") != 0 && (n.o.settingsimagepos == "left" ? n.n.searchsettings.css({
                        display: "block",
                    ...
                    })), n.n.resultsDiv.css("visibility") != "hidden" && n.o.resultsposition != "block") {
                    var r = n.n.container.width() - (n.n.resultsDiv.outerWidth(!0) - n.n.resultsDiv.width()),
                        u = r < 240 ? 240 : r;
                    n.n.resultsDiv.css({
                        width: u,
                        top: n.n.container.offset().top + n.n.container.outerHeight(!0) + 10 - i,
                        left: n.n.container.offset().left + (r - u)
                    })
                }
            },
            scrolling: function(n) {
                var i = this,
                    r = 0;
                if (t("body").css("position") != "static" && (r = t("body").offset().top), (n == !0 || i.n.searchsettings.css("visibility") == "visible") && (i.o.settingsimagepos == "left" ? i.n.searchsettings.css({
                        display: "block",
                        top: i.n.prosettings.offset().top + i.n.prosettings.height() - 2 - r,
                        left: i.n.prosettings.offset().left
                    }) : i.n.searchsettings.css({
                        display: "block",
                        top: i.n.prosettings.offset().top + i.n.prosettings.height() - 2 - r,
                        left: i.n.prosettings.offset().left + i.n.prosettings.width() - i.n.searchsettings.width()
                    })), n == !0 || i.n.resultsDiv.css("visibility") == "visible") {
                    var u = i.n.container.width() - (i.n.resultsDiv.outerWidth(!0) - i.n.resultsDiv.width()),
                        f = u < 240 ? 240 : u;
                    (i.o.resultsposition != "hover" && i.n.resultsAppend.length > 0 || i.n.container.hasClass("hiddend")) && (f = "auto");
                    i.n.resultsDiv.css({
                        width: f,
                        top: i.n.container.offset().top + i.n.container.outerHeight(!0) + 10 - r,
                        left: i.n.container.offset().left + (u - f)
                    })
                }
            }
        };
        ...
        function f(n, i, r) {
            ...
            typeof r != "undefined" && r !== null && t.each(r, function(n, i) {
                t("<input />", {
                    type: "hidden",
                    name: n,
                    value: i
        ...
        function c() {
            return typeof i.navigator != "undefined" && typeof i.navigator.userAgent != "undefined" ? i.navigator.userAgent.match(/(iPod|iPhone|iPad)/) != null : !1
        }
        ...
        t.plugin = function(n, i) {
            t.fn[n] = function(r) {
                return this.each(function() {
                    t.data(this, n) || t.data(this, n, Object.create(i).init(r, this))
                })
            }
        };
        t.plugin("ajaxsearchlite", o);
        var e = {
...
function(n, t, i) {
    i.ASL = i.ASL || {};
    i.ASL.getScope = function() {
        return typeof n != "undefined" ? n : typeof i[ASL.js_scope] != "undefined" ? i[ASL.js_scope] : eval(ASL.js_scope)
    };
    i.ASL.initialized = !1;
    i.ASL.initialize = function(n) {
        var i = this;
