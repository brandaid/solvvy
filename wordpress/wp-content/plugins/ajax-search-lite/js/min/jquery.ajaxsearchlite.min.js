...
jQuery.extend({
    highlight: function(n, t, i, r) {
        if (n.nodeType === 3) {
            var e = n.data.match(t);
            if (e) {
                var o = document.createElement(i || "span");
                o.className = r || "highlight";
                var u = n.splitText(e.index);
                u.splitText(e[0].length);
                var s = u.cloneNode(!0);
                return o.appendChild(s), u.parentNode.replaceChild(o, u), 1
            }
        } else if (n.nodeType === 1 && n.childNodes && !/(script|style)/i.test(n.tagName) && !(n.tagName === i.toUpperCase() && n.className === r))
            for (var f = 0; f < n.childNodes.length; f++) f += jQuery.highlight(n.childNodes[f], t, i, r);
        return 0
    }
});
...
(function(n) {
    var f = {
        init: function(t, i) {
            ...
            }), r.createVerticalScroll(), e() && r.n.container.addClass("asl_msie"), r.initSettingsAnimations(), r.initResultsAnimations(), r.initEvents(), r.initEtc(), this
        },
        ...
        initEvents: function() {
            ...
            n(t.n.text.parent()).submit(function(n) {
                if (n.preventDefault(), i())
                    if (t.o.redirect_on_enter) {
                        ...
                        t.n.text.trigger(r)
                    } else t.search(), document.activeElement.blur();
                else t.search()
            });
            t.n.text.click(function() {
            ...
            t.n.proclose.bind("click touchend", function() {
                t.opened != !1 && (t.n.text.val(""), t.n.textAutocomplete.val(""), t.hideResults(), t.n.text.focus())
            });
            ...
            s() && i() && o() && parseInt(t.n.text.css("font-size")) < 16 && (t.n.text.data("fontSize", t.n.text.css("font-size")).css("font-size", "16px"), t.n.textAutocomplete.css("font-size", "16px"), n("<style>#ajaxsearchlite" + t.o.rid + " input.orig::-webkit-input-placeholder{font-size: 16px !important;}<\/style>").appendTo("head"));
        ...
        initEtc: function() {
            var t = this,
                i = null;
            n("div.asl_option", t.n.searchsettings).on("mouseup touchend", function() {
                n('input[type="checkbox"]', this).prop("checked", !n('input[type="checkbox"]', this).prop("checked"));
                clearTimeout(i);
                var t = this;
                i = setTimeout(function() {
                    n('input[type="checkbox"]', t).trigger("asl_chbx_change")
                }, 50)
            });
        ...
        initMagnifierEvent: function() {
            var i = this,
                f;
            i.n.promagnifier.add(i.n.text).bind("click keyup", function(e) {
                window.event ? (i.keycode = window.event.keyCode, i.ktype = window.event.type) : e && (i.keycode = e.which, i.ktype = e.type);
                var o = n(this).hasClass("orig");
                if (i.n.text.val().length < i.o.charcount) {
                ...
                if (!o && i.o.redirectonclick == 1 && i.ktype == "click" && i.o.redirectClickTo != "first_result" || o && i.o.redirect_on_enter == 1 && i.ktype == "keyup" && i.keycode == 13 && i.o.redirectEnterTo != "first_result") {
                    var h = i.ktype == "click" ? i.o.redirectClickTo : i.o.redirectEnterTo;
                    if (h == "results_page") var s = "?s=" + t(i.n.text.val());
                    else if (h == "woo_results_page") var s = "?post_type=product&s=" + t(i.n.text.val());
                    else var s = i.o.redirect_url.replace("{phrase}", t(i.n.text.val()));
                    i.o.overridewpdefault ? i.o.override_method == "post" ? r(i.o.homeurl + s, "post", {
                        asl_active: 1,
                        p_asl_data: n("form", i.n.searchsettings).serialize()
                    }) : location.href = i.o.homeurl + s + "&asl_active=1&p_asid=" + i.o.id + "&p_asl_data=" + u.encode(n("form", i.n.searchsettings).serialize()) : r(i.o.homeurl + s, "post", {
                ...
                if ((!(i.keycode >= 37) || !(i.keycode <= 40)) && (!(i.keycode >= 112) || !(i.keycode <= 123))) {
                    if (o && i.ktype == "click" || i.keycode == 32) {
                        n("form", i.n.searchsettings).serialize() + i.n.text.val().trim() == i.lastSuccesfulSearch && (i.n.proclose.css("display", "block"), i.resultsOpened || i.showResults());
                        return
                    }
                    n(this).hasClass("orig") && i.ktype == "click" || (i.o.triggeronclick != 0 || i.ktype != "click") && (i.o.triggerontype != 0 || i.ktype != "keyup") && (i.post != null && i.post.abort(), clearTimeout(f), i.hideLoader(), f = setTimeout(function() {
                        n("form", i.n.searchsettings).serialize() + i.n.text.val().trim() != i.lastSuccesfulSearch ? i.search() : (i.n.proclose.css("display", "block"), i.resultsOpened || i.showResults())
                    }, 250))
                }
            })
        },
        ...
        search: function() {
            var i = this;
            $('#search_modal').show();
            if ((!i.searching || !0) && !(i.n.text.val().length < i.o.charcount)) {
                i.searching = !0;
                i.n.proloading.css({
                    display: "block"
                });
                ...
                var f = {
                    ...
                    aslp: i.n.text.val(),
                    asid: i.o.id,
                    options: n("form", i.n.searchsettings).serialize()
                };
                if (JSON.stringify(f) === JSON.stringify(i.lastSearchData)) return i.resultsOpened || i.showResults(), i.hideLoader(), !1;
                i.analytics(i.n.text.val());
                i.post = n.post(ASL.ajaxurl, f, function(e) {
                    if (e = e.replace(/^\s*[\r\n]/gm, ""), e = e.match(/!!ASLSTART!!(.*[\s\S]*)!!ASLEND!!/)[1], i.n.resdrg.html(""), i.n.resdrg.html(e), n(".asl_keyword", i.n.resdrg).bind("click", function() {
                            i.n.text.val(n(this).html());
                            n("input.orig", i.n.container).val(n(this).html()).keydown();
                            n("form", i.n.container).trigger("submit", "ajax");
                            i.search()
                        }), i.n.items = n(".item", i.n.resultsDiv), n(".asl_res_url", i.n.resultsDiv).length > 0 && i.o.redirectonclick == 1 && i.ktype == "click" && i.o.redirectClickTo != "results_page" || i.o.redirect_on_enter == 1 && i.ktype == "keyup" && i.keycode == 13 && i.o.redirectEnterTo != "results_page") return location.href = n(n(".asl_res_url", i.n.resultsDiv).get(0)).attr("href"), !1;
                    if (i.hideLoader(), i.showResults(), i.scrollToResults(), i.lastSuccesfulSearch = n("form", i.n.searchsettings).serialize() + i.n.text.val().trim(), i.lastSearchData = f, i.n.items.length == 0) i.n.showmore != null && i.n.showmore.css("display", "none");
                    else if (i.n.showmore != null) {
                        i.n.showmore.css("display", "block");
                        n("a", i.n.showmore).off();
                        n("a", i.n.showmore).on("click", function() {
                            var e = i.o.redirectClickTo,
                                f = "?s=" + t(i.n.text.val());
                            f = e == "results_page" ? "?s=" + t(i.n.text.val()) : e == "woo_results_page" ? "?post_type=product&s=" + t(i.n.text.val()) : i.o.redirect_url.replace("{phrase}", t(i.n.text.val()));
                            i.o.overridewpdefault ? i.o.override_method == "post" ? r(i.o.homeurl + f, "post", {
                                asl_active: 1,
                                p_asl_data: n("form", i.n.searchsettings).serialize()
                            }) : location.href = i.o.homeurl + f + "&asl_active=1&p_asid=" + i.o.id + "&p_asl_data=" + u.encode(n("form", i.n.searchsettings).serialize()) : r(i.o.homeurl + f, "post", {
                                np_asl_data: n("form", i.n.searchsettings).serialize()
                            })
                        })
                    }
        ...
        resize: function() {
            var t = this,
                i = 0;
            if (n("body").css("position") != "static" && (i = n("body").offset().top), e() && 0 && (t.n.proinput.css({
                    width: t.n.probox.width() - 8 - (t.n.proinput.outerWidth(!1) - t.n.proinput.width()) - t.n.proloading.outerWidth(!0) - t.n.prosettings.outerWidth(!0) - t.n.promagnifier.outerWidth(!0) - 10
                }), t.n.text.css({
                    width: t.n.proinput.width() - 2 + t.n.proloading.outerWidth(!0),
                    position: "absolute",
                    zIndex: 2
                }), t.n.textAutocomplete.css({
                    width: t.n.proinput.width() - 2 + t.n.proloading.outerWidth(!0),
                    opacity: .25,
                    zIndex: 1
                })), t.n.prosettings.attr("opened") != 0 && (t.o.settingsimagepos == "left" ? t.n.searchsettings.css({
                    display: "block",
                    top: t.n.prosettings.offset().top + t.n.prosettings.height() - 2 - i,
                ...
                })), t.n.resultsDiv.css("visibility") != "hidden" && t.o.resultsposition != "block") {
                var r = t.n.container.width() - (t.n.resultsDiv.outerWidth(!0) - t.n.resultsDiv.width()),
                    u = r < 240 ? 240 : r;
                t.n.resultsDiv.css({
                    width: u,
                    top: t.n.container.offset().top + t.n.container.outerHeight(!0) + 10 - i,
                    left: t.n.container.offset().left + (r - u)
                })
            }
        },
        scrolling: function(t) {
            var i = this,
                r = 0;
            if (n("body").css("position") != "static" && (r = n("body").offset().top), (t == !0 || i.n.searchsettings.css("visibility") == "visible") && (i.o.settingsimagepos == "left" ? i.n.searchsettings.css({
                    display: "block",
                ...
                })), t == !0 || i.n.resultsDiv.css("visibility") == "visible") {
    ...
    n.plugin("ajaxsearchlite", f);
    var u = {
        _keyStr: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
        encode: function(n) {
            var e = "",
                o, t, i, h, c, s, r, f = 0;
            for (n = u._utf8_encode(n); f < n.length;) o = n.charCodeAt(f++), t = n.charCodeAt(f++), i = n.charCodeAt(f++), h = o >> 2, c = (o & 3) << 4 | t >> 4, s = (t & 15) << 2 | i >> 6, r = i & 63, isNaN(t) ? s = r = 64 : isNaN(i) && (r = 64), e = e + this._keyStr.charAt(h) + this._keyStr.charAt(c) + this._keyStr.charAt(s) + this._keyStr.charAt(r);
            return e
        },
        decode: function(n) {
            var t = "",
                o, s, h, c, f, r, e, i = 0;
            for (n = n.replace(/[^A-Za-z0-9\+\/\=]/g, ""); i < n.length;) c = this._keyStr.indexOf(n.charAt(i++)), f = this._keyStr.indexOf(n.charAt(i++)), r = this._keyStr.indexOf(n.charAt(i++)), e = this._keyStr.indexOf(n.charAt(i++)), o = c << 2 | f >> 4, s = (f & 15) << 4 | r >> 2, h = (r & 3) << 6 | e, t = t + String.fromCharCode(o), r != 64 && (t = t + String.fromCharCode(s)), e != 64 && (t = t + String.fromCharCode(h));
            return u._utf8_decode(t)
        },
